...
namespace Cortador
{
    public partial class NuevoEvento : PaginaBaseCAPP
    {
        /// <summary>
        /// Realiza y controla la carga de la página Nuevo Evento
        /// </summary>
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //LNEvento.CreaModificaEvento(evento, this.Usuario);
        ...
        protected void btnActivaReglas_Click(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                //LNEvento.CreaModificaEventoReglas(dt, this.Usuario);
        ...
        protected void btnActivaPlugins_Click(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                //LNEvento.CreaModificaEventoPlugins(dt, this.Usuario);
