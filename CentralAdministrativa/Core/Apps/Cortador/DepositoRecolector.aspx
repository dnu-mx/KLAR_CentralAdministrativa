<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DepositoRecolector.aspx.cs" Inherits="Cortador.DepositoRecolector" %>
            ...
            <ext:BorderLayout ID="BorderLayout1" runat="server">
                <Center Split="true">
                    <ext:FormPanel ID="FormPanel1" Frame="true" runat="server" Border="false">
                        ...
                        <Items>
                            <ext:FieldSet ID="FielSetDatos" runat="server" Title="Datos del Depósito" Height="250"
