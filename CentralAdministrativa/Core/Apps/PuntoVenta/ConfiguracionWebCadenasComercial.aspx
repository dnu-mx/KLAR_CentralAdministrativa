<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="ConfiguracionWebCadenasComercial.aspx.cs" Inherits="TpvWeb.ConfiguracionWebCadenasComercial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent"  runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server" ValidateRequestMode="Disabled">
        ...
        <East Split="true">
            <ext:Panel ID="Panel5" runat="server" Width="550" Title="Cuentas del Cadenas Comercial"
                ...
                <Content>
                    <ext:PropertyGrid ID="GridPropiedades" runat="server" ValidateRequestMode="Disabled" Width="700" AutoHeight="true">
                        <Source>
                            <ext:PropertyGridParameter Name="(Aplicacion)" Value="Punto de Venta Web" />
                        </Source>
                        <View>
