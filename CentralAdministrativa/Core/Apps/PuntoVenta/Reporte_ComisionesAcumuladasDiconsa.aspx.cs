...
namespace TpvWeb
{
    public partial class Reporte_ComisionesAcumuladasDiconsa : PaginaBaseCAPP
    {
        ...
        private void BuscaDatosAndBind()
        {
            try
            {
                ...
                GridPanel1.GetStore().DataSource = LNReportes.ListarComisionesAcumuladasDiconsa(
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                Store1.RemoveAll();
                X.Msg.Alert("Comisiones Acumuladas", err.Message).Show();
            }
        }
