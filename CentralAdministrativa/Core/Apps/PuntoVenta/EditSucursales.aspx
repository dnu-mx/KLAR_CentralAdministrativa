<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditSucursales.aspx.cs" Inherits="TpvWeb.EditSucursales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        <Center Split="true">
            <ext:Panel ID="Panel2" runat="server" Title="Sucursales" Collapsed="false"
            ...
            <ext:FormPanel ID="FormPanel1" Width="428.5" Title="Mi Grupo Comercial" runat="server"
                ...
                <Items>
                    <ext:TabPanel runat="server" ActiveTabIndex="0" TabPosition="Bottom" Border="false"
                        ...
                        <Items>
                            <ext:Panel ID="Panel1" runat="server" Title="Sucursal" AutoHeight="true" FormGroup="true">
                                <Content>
                                ...
                                <Items>
                                    ...
                                    <ext:TextField ID="txtAmaterno" FieldLabel="Ubicación 2" AllowBlank="false"
                                        MsgTarget="Side" MaxLength="50" runat="server" Width="400" Text="" />
                                  
                                     <ext:TextField ID="txtClaveSupervisor" InputType="Password" FieldLabel="Clave o Tarjeta de Supervisor (Sólo para TPVS)" AllowBlank="true"
                                        MsgTarget="Side" MaxLength="50"  runat="server" Width="400" Text="" >
                                        </ext:TextField>
