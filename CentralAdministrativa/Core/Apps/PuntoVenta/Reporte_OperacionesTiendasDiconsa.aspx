<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reporte_OperacionesTiendasDiconsa.aspx.cs" Inherits="TpvWeb.Reporte_OperacionesTiendasDiconsa" %>
                ...
                <Items>
                    <ext:Panel ID="Panel1" runat="server" Layout="FitLayout">
                        <Items>
                            ...
                            <ext:ComboBox ID="cmbBeneficiario" FieldLabel="Marca" TabIndex="9" EmptyText="Todas"
                            ...
                            <ext:TextField ID="txtTelefono" FieldLabel="Referencia" EmptyText="Todas" TabIndex="10"
                    ...
                    <ext:BorderLayout ID="BorderLayout2" runat="server">
                        <Center Split="true">
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                Header="false" Border="false" AutoExpandColumn="Referencia">
                                ...
                                <Plugins>
                                    <ext:GridFilters runat="server" ID="GridFilters1" Local="true">
                                        <Filters>
                                            ...
                                            <ext:StringFilter DataIndex="Marca" />
