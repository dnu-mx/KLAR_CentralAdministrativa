<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="AddSucursales.aspx.cs" Inherits="TpvWeb.AddSucursales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        <West Split="true">
            <ext:FormPanel ID="FormPanel1" Width="350" Title="Agregar Sucursales" runat="server"
                ...
                <Items>
                    <ext:TabPanel runat="server" ActiveTabIndex="0" TabPosition="Bottom" Border="false"
                        ...
                        <Items>
                            <ext:Panel ID="Panel1" runat="server" Title="Nueva Sucursal" AutoHeight="true" FormGroup="true">
                                <Content>
                                    ...
                                    <ext:Store ID="SAfiliaciones" runat="server">
                                        ...
                                        <SortInfo Field="NombreAfiliacion" />
                                    </ext:Store>
                                </Content>
                                <Items>
                                    ...
                                    <ext:ComboBox ID="cmbPadreTipoColectiva" FieldLabel="Cadena Comercial" AllowBlank="false"
                                        ...
                                        MinChars="1" MatchFieldWidth="false" Name="colCadena">
                                    </ext:ComboBox>
                                    <ext:TextField ID="txtUserName" FieldLabel="Clave" AllowBlank="false" MsgTarget="Side"
                                        MaxLength="8" runat="server" Text="" Width="320" />
                                    ...
                                    <ext:TextField ID="txtApaterno" FieldLabel="Ubicación 1" AllowBlank="false" MsgTarget="Side"
                                        MaxLength="50" runat="server" Text="" Width="320" />
                                    <ext:TextField ID="txtAmaterno" FieldLabel="Ubicación 2"  Visible="true" AllowBlank="false" MsgTarget="Side"
                                        MaxLength="50" runat="server" Width="320" Text="" />
                                    <ext:DateField FieldLabel="Fecha" AllowBlank="false" MsgTarget="Side" Format="yyyy-MM-dd"
                                        Name="Fecha Inicio" TabIndex="4" ID="datFecha"  Visible="true" Width="320" runat="server" EmptyText="Selecciona una Opción"
        ...
        <Center Split="true">
            <ext:Panel ID="Panel5" runat="server" Title="Las Sucursales" Collapsed="false" Layout="Fit"
