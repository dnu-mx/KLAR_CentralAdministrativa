...
namespace TpvWeb
{
    public partial class Reporte_ComisionesDiconsa : PaginaBaseCAPP
    {
        ...
        private void BuscaDatosAndBind()
        {
            try
            {
                ...
                GridPanel1.GetStore().DataSource = LNReportes.ListarComisionesDiconsa(
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                Store1.RemoveAll();
                X.Msg.Alert("Comisiones", err.Message).Show();
            }
        }
