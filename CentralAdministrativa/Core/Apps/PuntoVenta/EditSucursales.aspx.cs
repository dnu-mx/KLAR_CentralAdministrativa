...
namespace TpvWeb
{
    public partial class EditSucursales : PaginaBaseCAPP
    {
        ...
        protected void DespliegaDatosColectiva(Int64 ID_Colectiva)
        {
            ...
            FormPanel1.Title = "Editando la Sucursal Número [" + laColectivaEditar.ID_Colectiva + "]";
            ...
            txtClaveSupervisor.Text = laColectivaEditar.APaterno;
