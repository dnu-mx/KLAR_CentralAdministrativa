...
{
    public partial class ParametrosPuntoVenta : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        protected void PreparaGridEmpleados()
        {
            ...
            config.ToolTip.Text = "Editar Parámetros";
        ...
        protected void PreparaGridParametros(Int64 ID_CadenaComercial)
        {
            try
            {
                ...
                foreach (Propiedad unaProp in LNPropiedad.ObtieneParametrosEnPDV(ID_CadenaComercial,
        ...
        protected void Button1_Click(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                if (losCambios.Count > 0)
                {
                    ...
                    LNPropiedad.ActualizaParametrosEnPDV(losCambios, Int64.Parse(HttpContext.Current.Session["ID_Colectiva"].ToString()), ContextoInicial.ContextoServicio.ConnectionString, this.Usuario);

                    //Se actualiza la versión de los parámetros en BD
                    LNPropiedad.ActualizaVersionParametrosEnPDV(Int64.Parse(HttpContext.Current.Session["ID_Colectiva"].ToString()), ContextoInicial.ContextoServicio.ConnectionString, this.Usuario);
        ...
        /// <summary>
        /// Registra en bitácora el cambio en los parámetros de la cadena
        /// </summary>
        ...
        protected void RegistraEnBitacora(List<Propiedad> lasPropiedades)
        {
            try
            {
                ...
                {
                    DAOPropiedad.InsertaRegistroBitacoraServ(unaPropiedad, ContextoInicial.ContextoServicio.ConnectionString, this.Usuario);
                }
            }

            catch (Exception ex)
            {
                Loguear.Evento("NO se Insertó un Cambio de Valor de Parámetro en la Bitácora Detalle de ServicioTPV. " + ex.Message, this.Usuario.ClaveUsuario);
            }
        }
