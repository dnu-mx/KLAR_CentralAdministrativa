<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reporte_ComisionesDiconsa.aspx.cs" Inherits="TpvWeb.Reporte_ComisionesDiconsa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
                            ...
                            <ext:Button ID="btnBuscar" runat="server" Text="Buscar..." Icon="Magnifier">
                                <DirectEvents>
                                    <Click OnEvent="btnBuscar_Click" Before="var valid= #{FormPanel1}.getForm().isValid(); if (!valid) {} return valid;">
                                        <EventMask ShowMask="true" Msg="Obteniendo Comisiones..." MinDelay="500" />
                                    </Click>
                                </DirectEvents>
                            </ext:Button>
                        </Items>
        ...
        <Center Split="true" Collapsible="false">
            <ext:Panel ID="Panel2" runat="server" Title="Comisiones Obtenidas con el Filtro Seleccionado"
                            ...
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel1" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="ComTelcelDelCorte" Header="Comisiones Telcel" Sortable="true"
                                            DataIndex="ComTelcelDelCorte" Width="120">
                                            <Renderer Format="UsMoney" />
                                        </ext:Column>
                                        <ext:Column ColumnID="ComOtrasDelCorte" Header="Comisiones Multimarca" Sortable="true" 
                                            DataIndex="ComOtrasDelCorte" Width="140">
                                            <Renderer Format="UsMoney" />
                                        </ext:Column>
                                        <ext:Column ColumnID="ComPDSDelCorte" Header="Comisiones Pago de Servicios" Sortable="true" 
                                            DataIndex="ComPDSDelCorte" Width="180">
                                            <Renderer Format="UsMoney" />
                                        </ext:Column>
                                        <ext:Column ColumnID="ComTotalesDelCorte" Header="Total de Comisiones" Sortable="true"
                                            DataIndex="ComTotalesDelCorte" Width="120">
                                            <Renderer Format="UsMoney" />
                                        </ext:Column>
                                    </Columns>
                                </ColumnModel>
                                <Plugins>
                                    <ext:GridFilters runat="server" ID="GridFilters1" Local="true">
                                        <Filters>
                                            ...
                                            <ext:StringFilter DataIndex="ComTelcelDelCorte" />
                                            <ext:StringFilter DataIndex="ComOtrasDelCorte" />
                                            <ext:StringFilter DataIndex="ComPDSDelCorte" />
                                            <ext:StringFilter DataIndex="ComTotalesDelCorte" />
                                        </Filters>
                                    </ext:GridFilters>
                                </Plugins>
                                <BottomBar>
                                    <ext:PagingToolbar ID="PagingToolBar1" runat="server" StoreID="Store1" DisplayInfo="true"
                                        DisplayMsg="Mostrando Comisiones {0} - {1} de {2}" />
                                </BottomBar>
                                <TopBar>
