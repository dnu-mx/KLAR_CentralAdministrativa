<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="ParametrosPuntoVenta.aspx.cs" Inherits="PuntoVenta.ParametrosPuntoVenta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent"  runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server" ValidateRequestMode="Disabled">
        ...
        <East Split="true">
            <ext:Panel ID="Panel5" runat="server" Width="550" Title="Parámetros en Punto de Venta"
