<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Reporte_OperacionesCadConcentrado.aspx.cs" Inherits="TpvWeb.Reporte_OperacionesCadConcentrado" %>
                                                        ...
                                                        <DirectEvents>
                                                            <Click OnEvent="ExportGridToExcel" IsUpload="true" Success="Ext.Net.DirectMethods.Download({IsUpload:true})">
                                                                <ExtraParams>
                                                                    ...
                                                                    <ext:Parameter Name="Reporte" Value="AD" Mode="Value" />
                                                                </ExtraParams>
                                                            </Click>
                                                        </DirectEvents>
                                                    </ext:Button>
                                                ...
                                                <Items>
                                                    ...
                                                    <ext:Button ID="Button3" runat="server" Text="Exportar a Excel" Icon="PageExcel">
                                                        <DirectEvents>
                                                            <Click OnEvent="ExportGridToExcel" IsUpload="true" Success="Ext.Net.DirectMethods.Download({IsUpload:true})">
                                                                <ExtraParams>
                                                                    <ext:Parameter Name="GridToExport" Value="Ext.encode(#{GridPanel2}.getRowsValues({selectedOnly : false}))" Mode="Raw" />
                                                                    <ext:Parameter Name="Reporte" Value="AC" Mode="Value" />
                                                                </ExtraParams>
                                                            </Click>
                                                        </DirectEvents>
                                                    </ext:Button>
                                                ...
                                                <Items>
                                                    ...
                                                    <ext:Button ID="Button6" runat="server" Text="Exportar a Excel" Icon="PageExcel">
                                                        <DirectEvents>
                                                            <Click OnEvent="ExportGridToExcel" IsUpload="true" Success="Ext.Net.DirectMethods.Download({IsUpload:true})">
                                                                <ExtraParams>
                                                                    <ext:Parameter Name="GridToExport" Value="Ext.encode(#{GridPanel3}.getRowsValues({selectedOnly : false}))" Mode="Raw" />
                                                                    <ext:Parameter Name="Reporte" Value="AG" Mode="Value" />
                                                                </ExtraParams>
                                                            </Click>
                                                        </DirectEvents>
                                                    </ext:Button>
