<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="Reporte_SpeiOut.aspx.cs" Inherits="TpvWeb.Reporte_SpeiOut" %>
        ...
        <Center Split="true">
            <ext:GridPanel ID="GridPanelTraspasos" runat="server" StripeRows="true" Header="false" Border="false"
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ID_RegistroSTP">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="CuentaClabeOrigen" />
                                    <ext:RecordField Name="NombreOrdenante" />
                                    <ext:RecordField Name="InstitucionOrdenante" />
                                    <ext:RecordField Name="ClabeTarjetaDestino" />
                                    <ext:RecordField Name="NombreDestinatario" />
                                    <ext:RecordField Name="MontoOperacion" />
                                    <ext:RecordField Name="ClaveRastreo" />
                                    <ext:RecordField Name="RfcDestinatario" />
                                </Fields>
                            </ext:JsonReader>
                        </Reader>
                    </ext:Store>
                ...
                <ColumnModel ID="ColumnModel1" runat="server">
                    <Columns>
                        <ext:DateColumn Header="Fecha Operacion" Sortable="true" DataIndex="FechaOperacion" Format="yyyy-MM-dd HH:mm:ss" />
                        <ext:Column Header="Cuenta Clabe Origen" Sortable="true" DataIndex="CuentaClabeOrigen" />
                        <ext:Column Header="Nombre Ordenante" Sortable="true" DataIndex="NombreOrdenante" />
                        <ext:Column Header="Institucion Ordenante" Sortable="true" DataIndex="InstitucionOrdenante" />
                        <ext:Column Header="Clabe Tarjeta Destino" Sortable="true" DataIndex="ClabeTarjetaDestino" />
                        <ext:Column Header="Nombre Destinatario" Sortable="true" DataIndex="NombreDestinatario" />
                        <ext:NumberColumn Header="Monto Operacion" Sortable="true" DataIndex="MontoOperacion" Align="Right" Format="0,0.00"/>
                        <ext:Column Header="Clave Rastreo" Sortable="true" DataIndex="ClaveRastreo" />
                    </Columns>
                </ColumnModel>
                <View>
