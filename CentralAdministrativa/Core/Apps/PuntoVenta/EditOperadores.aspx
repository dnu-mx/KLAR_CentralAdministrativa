<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EditOperadores.aspx.cs" Inherits="TpvWeb.EditOperadores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        <Center Split="true">
            <ext:Panel ID="Panel2" runat="server" Title="Operadores" Collapsed="false" Layout="FitLayout"
                            ...
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store2" StripeRows="true"
                                ...
                                <TopBar>
                                    <ext:Toolbar ID="Toolbar2" runat="server">
                                        <Items>
                                            <ext:TextField TabIndex="5" EmptyText="Clave" MaxLength="100" ID="txtBuscarUsuario"
                                                runat="server" Width="180" Text="" />
                                            <ext:TextField TabIndex="5" EmptyText="Nombre" MaxLength="16" ID="txtBuscarNombre"
                                                runat="server" Width="180" Text="" />
                                            <ext:TextField TabIndex="5" EmptyText="Apellido Paterno" MaxLength="100" ID="txtBuscarPaterno"
                                                runat="server" Width="180" Text="" />
                                            <ext:Button ID="Button1" runat="server" Text="Buscar" Icon="Magnifier">
                                            <DirectEvents>
                                                <Click OnEvent="btnBuscar_Click">
                                                    <EventMask ShowMask="true" Msg="Buscando Operadores..." MinDelay="500" />
                                                </Click>
                                                </DirectEvents>
                                            </ext:Button>
                                ...
                                <DirectEvents>
                                    <RowDblClick OnEvent="GridEmpleados_DblClik">
                                        <EventMask ShowMask="true" Msg="Obteniendo Datos del Operador..." MinDelay="500" />
                                    </RowDblClick>
                                </DirectEvents>
                                <SelectionModel>
        ...
        <East Split="true">
            <ext:FormPanel ID="FormPanel1" Width="428.5" runat="server" Border="false"
                Collapsed="true" Collapsible="true" Layout="FitLayout">
                <Items>
                    <ext:Panel ID="Panel1" runat="server" Padding="10">
                        <Content>
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtPass1" FieldLabel="Password" Visible="true" AllowBlank="true"
                                MsgTarget="Side" MaxLength="20" InputType="Password" runat="server" Width="400"
                                Text="" />
                            <ext:TextField ID="txtPass2" FieldLabel="Repite Password" Visible="true" AllowBlank="true"
                            ...
                            <ext:ComboBox ID="cmbPadreTipoColectiva" EmptyText="Selecciona una Opción" Enabled="false"
                                ...
                                ValueField="ID_Colectiva" Visible="false">
                            </ext:ComboBox>
