<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddAfiliaciones.aspx.cs" Inherits="TpvWeb.AddAfiliaciones" %>
                        ...
                        <Items>
                            <ext:Panel ID="Panel1" runat="server" Title="Nueva Afiliación" AutoHeight="true" FormGroup="true">
                                ...
                                <ext:ComboBox ID="cmbTipoUsuario" FieldLabel="Tipo Entidad" AllowBlank="false"
                                    ...
                                    <ext:TextField ID="txtUserName" FieldLabel="Número"  MsgTarget="Side"  Disabled="true"
