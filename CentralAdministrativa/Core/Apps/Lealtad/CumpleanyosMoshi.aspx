<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CumpleanyosMoshi.aspx.cs" Inherits="Lealtad.CumpleanyosMoshi" %>
                            ...
                            <ext:FormPanel ID="FormPanel1" runat="server" Border="false" Layout="ColumnLayout"
                                ...
                                <Items>
                                    ...
                                    <ext:Panel ID="Panel1" runat="server" Border="false" Width="300" Height="210">
                                        <Items>
                                            <ext:Image ID="Image1" runat="server" AnchorHorizontal="100%" AnchorVertical="100%"
                                            ...
                                            <ext:Panel ID="Panel4" runat="server" Border="false" Header="false" LabelAlign="Left" Layout="FormLayout">
                                                <Items>
                                                    <ext:Label runat="server" ID="lblDescripcionRegla" Cls="descripcion" FieldLabel="Descripción"
                                                        Text="A los clientes que cumplan años en el mes se les bonificará un premio en puntos.">
                                                    </ext:Label>
                                                </Items>
                                            </ext:Panel>
