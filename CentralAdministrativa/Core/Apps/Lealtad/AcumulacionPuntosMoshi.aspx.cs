...
namespace Lealtad
{
    public partial class AcumulacionPuntosMoshi : DALCentralAplicaciones.PaginaBaseCAPP
    {
        /// <summary>
        /// Realiza y controla la carga de la página Acumulación de Puntos
        /// </summary>
            ...
            try
            {
                if (!IsPostBack)
                {
                    DataSet dsParamsRegla = DAOMoshi.ObtieneParamsRegla(Configuracion.Get(Guid.Parse(
                        ConfigurationManager.AppSettings["IDApplication"].ToString()), "ClaveReglaAcumulacionPuntos").Valor,
                    ...
                    HttpContext.Current.Session.Add("ID_ReglaAcum", IdRegla);
        ...
        protected void LlenaComboNivelesLealtad()
        {
            ...
            {
                X.Msg.Alert("Acumulación de Puntos", "Ocurrió un error al consultar los Niveles.").Show();
        ...
        protected void selectNivel_Click(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                Int64 IdRegla = Int64.Parse(HttpContext.Current.Session["ID_ReglaAcum"].ToString());
            ...
            {
                X.Msg.Alert("Acumulación de Puntos", "Ocurrió un error al consultar  los valores de la regla.").Show();
        ...
        /// <param name="ID_ReglaAcum">Identificador de la regla</param>
        ...
        protected void btnGuardar_Click(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                LNMoshi.ModificaValoresReglaPorGpoCuenta(losCambios, Int64.Parse(HttpContext.Current.Session["ID_CadenaMoshi"].ToString()), 
                    Int64.Parse(HttpContext.Current.Session["ID_ReglaAcum"].ToString()), 
