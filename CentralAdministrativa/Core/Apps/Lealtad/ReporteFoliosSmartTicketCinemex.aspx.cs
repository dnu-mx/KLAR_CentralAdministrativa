...
namespace Lealtad
{
    public partial class ReporteFoliosSmartTicketCinemex : DALCentralAplicaciones.PaginaBaseCAPP
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    HttpContext.Current.Session.Add("DtFolios", null);
                }
        ...
        protected void LlenaGridPanelFolios(int RegistroInicial, string Columna, SortDirection Orden)
        {
            ...
            try
            {
                ...
                dtFolios = HttpContext.Current.Session["DtFolios"] as DataTable;

                if (dtFolios == null)
                {
                    dtFolios = DAOEcommerceRedVoucher.ObtieneReporteFoliosCinemex(
                    ...
                    HttpContext.Current.Session.Add("DtFolios", dtFolios);
                }
        ...
        public void ExportDataTableToExcel()
        {
            try
            {
                string reportName = "ReporteFolios";
                DataTable _dtFolios = HttpContext.Current.Session["DtFolios"] as DataTable;
