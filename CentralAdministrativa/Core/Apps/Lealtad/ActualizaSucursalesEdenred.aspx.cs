...
namespace Lealtad
{
    public partial class ActualizaSucursalesEdenred : DALCentralAplicaciones.PaginaBaseCAPP
    {
        /// <summary>
        ...
        protected void ValidaMuestraYSubeArchivo(DataSet ds)
        {
            ...
            dt.AcceptChanges();
            LNEcommerceEdenred.InsertaSucursalesTMP(dt, this.Usuario);
        ...
        public void btnAplicarCambios_Click(object sender, DirectEventArgs e)
        {
            try
            {
                string respuestaBD = LNEcommerceEdenred.AplicaCambiosASucursales(this.Usuario);
