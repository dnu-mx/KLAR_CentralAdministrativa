<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteFoliosEdenred.aspx.cs"
    Inherits="Lealtad.ReporteFoliosEdenred" %>
                    ...
                    <ext:GridPanel ID="GridPanelFolios" runat="server" StripeRows="true" Layout="FitLayout" Region="Center">
                        <Store>
                            <ext:Store ID="StoreFolios" runat="server" OnSubmitData="StoreSubmit" RemoteSort="true" 
                                OnRefreshData="StoreFolios_RefreshData" >
                                <AutoLoadParams>
