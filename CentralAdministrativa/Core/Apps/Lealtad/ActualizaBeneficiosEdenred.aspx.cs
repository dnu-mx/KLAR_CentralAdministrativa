...
namespace Lealtad
{
    public partial class ActualizaBeneficiosEdenred : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        public void btnCargarArchivo_Click(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                LNEcommerceEdenred.InsertaArchivoTMP(dtCloned, this.Usuario);
        ...
        protected bool VerificaLongitudCampos(DataTable _dt)
        {
            ...
            try
            {
                DataSet dsLongitudes = DAOEcommerceEdenred.ObtieneLongitudCampos(this.Usuario);
        ...
        public void btnAplicarCambios_Click(object sender, DirectEventArgs e)
        {
            try
            {
                var response = LNEcommerceEdenred.AplicaCambios(this.Usuario);
