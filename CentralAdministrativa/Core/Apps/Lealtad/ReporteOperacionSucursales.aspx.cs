...
namespace Lealtad
{
    public partial class ReporteOperacionSucursales : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataSet dsOperaciones = DAOPromociones.ObtieneReporteOperacionesSucursales(
                ...
                if (dsOperaciones.Tables[0].Rows.Count < 1)
                {
                    X.Msg.Alert("Operaciones", "No existen coincidencias con la búsqueda solicitada").Show();
                }
                else
                {
                    StoreOperaciones.DataSource = dsOperaciones;
                    StoreOperaciones.DataBind();
            ...
            catch (Exception ex)
            {
                ...
                X.Msg.Alert("Operaciones", "Ocurrió un Error al Consultar el Reporte de Operaciones de Sucursales").Show();
            }
        }
        ...
        protected void ExportGridToExcel(object sender, DirectEventArgs e)
        {
            ...
            string reportName = "ReporteOperacionSucursales";
