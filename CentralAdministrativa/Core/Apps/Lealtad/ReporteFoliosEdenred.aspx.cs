...
namespace Lealtad
{
    public partial class ReporteFoliosEdenred : DALCentralAplicaciones.PaginaBaseCAPP
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    HttpContext.Current.Session.Add("DtFoliosEdn", null);
                }
        ...
        protected void LlenaGridPanelFolios(int RegistroInicial, string Columna, SortDirection Orden)
        {
            ...
            try
            {
                ...
                dtFolios = HttpContext.Current.Session["DtFoliosEdn"] as DataTable;

                if (dtFolios == null)
                {
                    dtFolios = DAOEcommerceRedVoucher.ObtieneReporteFoliosEdenred(
                    ...
                    HttpContext.Current.Session.Add("DtFoliosEdn", dtFolios);
                }
        ...
        public void ExportDataTableToExcel()
        {
            try
            {
                string reportName = "ReporteFoliosEdenred";
                DataTable _dtFolios = HttpContext.Current.Session["DtFoliosEdn"] as DataTable;
