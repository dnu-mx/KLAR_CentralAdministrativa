...
namespace Lealtad
{
    public partial class PorcentajeBonificado : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        private void BindDataCadenasComerciales()
        {
            ...
            cmbCadenaComercial.GetStore().DataSource = DAOCatalogos.ListaEmpleadosMiembrosClubGrupoComercial(-1, Configuracion.Get(IDApp, "ClaveTipoColectivaCadenaComercial").Valor, this.Usuario, Guid.Parse(ConfigurationManager.AppSettings["IdApplication"].ToString())); //, logTEMP);
        ...
        protected void GridEmpleados_DblClik(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                Int64 ID_Regla = Int64.Parse(e.ExtraParams["ID_Regla"]);
        ...
        protected void Button1_Click(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                LNRegla.ModificaValoresRegla(losCambios, Int64.Parse(HttpContext.Current.Session["ID_Colectiva"].ToString()),Int64.Parse(HttpContext.Current.Session["ID_Regla"].ToString()), this.Usuario);

                PreparaGripPropiedades(Int64.Parse(HttpContext.Current.Session["ID_Colectiva"].ToString()), Int64.Parse(HttpContext.Current.Session["ID_Regla"].ToString()));
