...
namespace Lealtad
{
    public partial class ReporteSucursalesEdenred : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    DataSet dsSucursales = DAOEcommerceEdenred.ListaSucursales(this.Usuario);
                    ...
                    StoreEstados.DataSource = DAOEcommerceEdenred.ListaEstados(this.Usuario);
        ...
        protected void LlenaGridPanelSucursales(int RegistroInicial, string Columna, SortDirection Orden)
        {
            ...
            try
            {
                ...
                if (dtSucursales == null)
                {
                    ...
                    dtSucursales = DAOEcommerceEdenred.ObtieneReporteSucursales(
        ...
        /// </summary>
        [DirectMethod(Namespace = "RepSucEdn")]
