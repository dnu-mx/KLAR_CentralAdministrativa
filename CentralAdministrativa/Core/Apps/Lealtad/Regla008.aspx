<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Regla008.aspx.cs" Inherits="Lealtad.Regla008" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout2" runat="server">
        <Content>
            <ext:Label runat="server" ID="ID_REGLA" Text="24" Visible="false" Cls="descripcion"
