<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Regla003.aspx.cs" Inherits="Lealtad.Regla003" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout2" runat="server">
        <Content>
            <ext:Label runat="server" ID="ID_REGLA" Text="19" Visible="false" Cls="descripcion"
