...
namespace Lealtad
{
    public partial class CargaMembresias_CCIMEF : DALCentralAplicaciones.PaginaBaseCAPP
    {
        /// <summary>
        ...
        protected void LlenaGridPanelMembresias(int RegistroInicial, string Columna, SortDirection Orden)
        {
            ...
            try
            {
                ...
                {
                    dtMembresias = DAOEcommerceCCIMEF.ObtieneReporteMembresiasCuponClick(
        ...
        public void btnCargarArchivo_Click(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                LNEcommerceCCIMEF.InsertaMembresiasTMP(dtCloned, this.Usuario);
        ...
        protected void ValidaMuestraYSubeArchivo(DataSet ds)
        {
            ...
            dt.AcceptChanges();
            LNEcommerceCCIMEF.InsertaMembresiasTMP(dt, this.Usuario);
        ...
        public void btnAplicarCambios_Click(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                string respuestaBD = LNEcommerceCCIMEF.AplicaCambiosAMembresias(programa, this.Usuario);
