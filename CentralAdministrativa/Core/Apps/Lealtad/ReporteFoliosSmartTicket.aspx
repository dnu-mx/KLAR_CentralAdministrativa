<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteFoliosSmartTicket.aspx.cs"
    Inherits="Lealtad.ReporteFoliosSmartTicket" %>
                    ...
                    <ext:GridPanel ID="GridPanelFolios" runat="server" StripeRows="true" Layout="FitLayout" Region="Center">
                                ...
                                <Reader>
                                    <ext:JsonReader IDProperty="ID">
                                        <Fields>
                                            ...
                                            <ext:RecordField Name="EmpresaAcceso" />
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ColumnID="EmpresaAcceso" Header="Empresa Acceso" Sortable="true" 
                                    DataIndex="EmpresaAcceso" Width="120" />
                                ...
                                <ext:Column ColumnID="IDOperacion" Header="No. Operación" Sortable="true" DataIndex="IDOperacion"
                                    Width="100" />
                                <ext:Column ColumnID="Origen" Header="Origen" Sortable="true" DataIndex="Origen" Width="100" />
                            </Columns>
                        </ColumnModel>
                        <TopBar>
