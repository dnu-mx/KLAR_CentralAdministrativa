<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PorcentajeBonificado.aspx.cs" Inherits="Lealtad.PorcentajeBonificado" %>
                            ...
                            <ext:FormPanel ID="FormPanel1" runat="server" Border="false" Layout="ColumnLayout"
                                ...
                                <Items>
                                    <ext:Panel runat="server" Border="false" Width="300" Height="210">
                                        <Items>
                                            <ext:Image runat="server" Width="300" Height="210" ImageUrl="Images/promociones.jpg">
                                            </ext:Image>
                                        </Items>
                                    </ext:Panel>
                                    <ext:Panel runat="server" Border="false" Layout="RowLayout" AutoScroll="true">
                                        <Items>
                                            <ext:Panel runat="server" Border="false" Header="false" LabelAlign="Left" Width="500"
                                                ...
                                                <Items>
                                                    <ext:Label runat="server" ID="lblNombreRegla" Cls="Titulo" FieldLabel="Nombre de Regla"
                                                        Text="Bonificación de Porcentaje de Compra en TAE">
                                                    </ext:Label>
                                                </Items>
                                            </ext:Panel>
                                            <ext:Panel runat="server" Border="false" Header="false" LabelAlign="Left" Layout="FormLayout">
                                                <Items>
                                                    <ext:Label runat="server" ID="lblDescripcionRegla" Cls="descripcion" FieldLabel="Descripción"
                                                        Text="Cada Compra sera evaluada y un porcentaje de la compra se abonará como Tiempo Aire al Cliente, habiendo un importe maximo por operacion y un maximo de abono por dia.">
                                                    </ext:Label>
                                                </Items>
                                            </ext:Panel>
                                            ...
                                            <ext:Panel ID="Panel1" runat="server" Border="false" Header="false" LabelAlign="Left"
                                                Layout="FormLayout">
                                                <Items>
                        ...
                        <East Collapsible="true">
                            <ext:Panel ID="PnlHeader" runat="server" Title="Parámetros Resultados." Region="Center"
                                ...
                                <Items>
                                    ...
                                    <ext:Label runat="server" ID="Label4" Cls="descripcion" FieldLabel="Regla de Uso de Parametros"
                                        Html="Del <b>@FechaInicio</b> al <b>@FechaFin</b> se acumulará el <b>@PorcentajeAbono</b> (%) de descuento sobre el monto total de la venta, hasta un máximo de <b>@ImporteMaximoOperacion</b> y <b>@ImporteMaximoDia</b>, Al acumular en la cuenta del tipo <b>@ID_TipoCuenta</b>  más o igual de <b>@MontoMinimoRecarga</b> dólares se disparará la recarga de Tiempo Aire.">
                                    </ext:Label>
