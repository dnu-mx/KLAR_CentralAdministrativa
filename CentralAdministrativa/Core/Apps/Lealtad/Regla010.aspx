<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Regla010.aspx.cs" Inherits="Lealtad.Regla010" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout2" runat="server">
        <Content>
            <ext:Label runat="server" ID="ID_REGLA" Text="26" Visible="false" Cls="descripcion"
