<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteOperacionSucursales.aspx.cs"
    Inherits="Lealtad.ReporteOperacionSucursales" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        ...
        <Center Split="true" Collapsible="false">
            <ext:FormPanel ID="FormPanelOperaciones" runat="server" Layout="FitLayout" Title="Operaciones obtenidas con los Filtros">
                <Items>
                    <ext:GridPanel ID="GridPanelOperaciones" runat="server" StripeRows="true" Layout="FitLayout" Region="Center">
                        <Store>
                            <ext:Store ID="StoreOperaciones" runat="server"  OnRefreshData="btnBuscar_Click"
                                ...
                                <Reader>
                                    <ext:JsonReader IDProperty="ID">
                                        <Fields>
                                            ...
                                            <ext:RecordField Name="Ciudad" />
                                            <ext:RecordField Name="Estado" />
                                            <ext:RecordField Name="NumRedenciones" />
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ColumnID="NumRedenciones" Header="No. Redenciones Acumuladas" Sortable="true" DataIndex="NumRedenciones"
                                    Width="160"/>
                                <ext:DateColumn ColumnID="FechaAlta" Header="Fecha de Alta de la Sucursal" Sortable="true"
                                    DataIndex="FechaAlta" Format="dd/MM/yyyy" Width="155"/>
                            </Columns>
                        </ColumnModel>
                        <TopBar>
                            <ext:Toolbar ID="Toolbar5" runat="server">
                                <Items>
                                        ...
                                        <DirectEvents>
                                            <Click OnEvent="ExportGridToExcel" IsUpload="true" Success="Ext.Net.DirectMethods.Download({IsUpload:true})"
                                                After="Ext.net.Mask.show({ msg : 'Exportando Reporte a Excel...' });
                                                    ...
                                                    Lealtad.StopMask();">
                                                <ExtraParams>
                                                    <ext:Parameter Name="GridResult" Value="Ext.encode(#{GridPanelOperaciones}.getRowsValues({selectedOnly : false}))" Mode="Raw" />
                                                </ExtraParams>
                                            </Click>
                                        </DirectEvents>
                                    </ext:Button>
                                    <ext:Button ID="btnExportCSV" runat="server" Text="Exportar a CSV" Icon="PageAttach" Disabled="true">
                                        <Listeners>
                                            <Click Handler="submitValue(#{GridPanelOperaciones}, #{FormatType}, 'csv');"  />
                                        </Listeners>
                                    </ext:Button>
                                </Items>
                            </ext:Toolbar>
