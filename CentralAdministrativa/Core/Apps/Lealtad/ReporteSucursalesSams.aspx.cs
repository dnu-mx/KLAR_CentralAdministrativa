...
namespace Lealtad
{
    public partial class ReporteSucursalesSams : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    DataSet dsSucursales = DAOEcommerceSams.ListaSucursales(this.Usuario);
        ...
        protected void LlenaGridPanelSucursales(int RegistroInicial, string Columna, SortDirection Orden)
        {
            ...
            try
            {
                ...
                if (dtSucursales == null)
                {
                    ...
                    dtSucursales = DAOEcommerceSams.ObtieneReporteSucursales(
        ...
        /// </summary>
        [DirectMethod(Namespace = "RepSucSams")]
