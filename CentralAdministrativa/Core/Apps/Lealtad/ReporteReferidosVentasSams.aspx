<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteReferidosVentasSams.aspx.cs"
    Inherits="Lealtad.ReporteReferidosVentasSams" %>
                    ...
                    <ext:GridPanel ID="GridPanelCupones" runat="server" StripeRows="true" Layout="FitLayout" AutoScroll="true">
                                ...
                                <Reader>
                                    <ext:JsonReader IDProperty="ID_Bitacora">
                                        <Fields>
                                            ...
                                            <ext:RecordField Name="FechaCanje" />
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:DateColumn Header="Fecha Canje" Sortable="true" DataIndex="FechaCanje"
                                    Format="dd/MM/yyyy HH:mm:ss" Width="120"/>
                                <ext:Column Header="Clave" Sortable="true" DataIndex="Clave" Width="150" />
                                ...
                                <ext:Column Header="Cuenta CLABE" Sortable="true" DataIndex="cuentaClabe" Width="150" />
                            </Columns>
                        </ColumnModel>
                        <TopBar>
