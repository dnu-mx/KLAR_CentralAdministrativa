<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteFoliosSmartTicketMC.aspx.cs"
    Inherits="Lealtad.ReporteFoliosSmartTicketMC" %>
                    ...
                    <ext:GridPanel ID="GridPanelFolios" runat="server" StripeRows="true" Layout="FitLayout" Region="Center">
                                ...
                                <Reader>
                                    <ext:JsonReader IDProperty="ID">
                                        <Fields>
                                            ...
                                            <ext:RecordField Name="AliasPedido" />
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ColumnID="AliasPedido" Header="AliasPedido" Sortable="true" DataIndex="AliasPedido" Width="120" />
                                ...
                                <ext:Column ColumnID="IDCliente" Header="IDCliente" Sortable="true" DataIndex="id_cliente" Width="120" />
