<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ActualizaSucursalesPrana.aspx.cs" Inherits="Lealtad.ActualizaSucursalesPrana" %>
                                    ...
                                    <ext:GridPanel ID="GridDatosArchivo" runat="server" StripeRows="true"
                                        ...
                                        <ColumnModel ID="ColumnModel12" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="Pais" Header="Pais" Sortable="true" DataIndex="Pais" Width="60"/>
                                                ...
                                                <ext:Column ColumnID="Clasificacion" Header="Clasificación" Sortable="true" DataIndex="Clasificacion" Width="200" />
                                            </Columns>
                                        </ColumnModel>
                                        <BottomBar>
