<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PorcentajeBonificarRangoVenta.aspx.cs" Inherits="Lealtad.PorcentajeBonificarRangoVenta" %>
                            ...
                            <ext:FormPanel ID="FormPanel1" runat="server" Border="false" Layout="ColumnLayout"
                                ...
                                <Items>
                                    <ext:Panel ID="Panel1" runat="server" Border="false" Width="300" Height="210">
                                        <Items>
                                            <ext:Image ID="Image1" runat="server" Width="300" Height="210" ImageUrl="Images/promocion2.jpg">
                                            </ext:Image>
                                        </Items>
                                    </ext:Panel>
                                    <ext:Panel ID="Panel2" runat="server" Border="false" Layout="RowLayout" AutoScroll="true">
                                        <Items>
                                            <ext:Panel ID="Panel3" runat="server" Border="false" Header="false" LabelAlign="Left" Width="500"
                                                ...
                                                <Items>
                                                    <ext:Label runat="server" ID="lblNombreRegla" Cls="Titulo" FieldLabel="Nombre de Regla"
                                                        Text="Bonificación de Porcentaje Por Rangos de la Compra en TAE">
                                                    </ext:Label>
                                                </Items>
                                            </ext:Panel>
                                            <ext:Panel ID="Panel4" runat="server" Border="false" Header="false" LabelAlign="Left" Layout="FormLayout">
                                                <Items>
                                                    <ext:Label runat="server" ID="lblDescripcionRegla" Cls="descripcion" FieldLabel="Descripción"
                                                        Text="Cada Compra será evaluada y de acuerdo a un rango de valores configurados determinará un porcentaje de la compra para ser abonado como Tiempo Aire al Cliente, habiendo un importe maximo por operacion y un maximo de abono por dia.">
                                                    </ext:Label>
                                                </Items>
                                            </ext:Panel>
                                            <ext:Panel ID="Panel14" Visible="false" runat="server" Border="false" Header="false"
                                                ...
                                                <Items>
                                                    <ext:Label runat="server" ID="Label1" Cls="descripcion" FieldLabel="Regla de Uso de Parametros"
						                            ...
						                            <tpl if="[xcount-xindex]==0">
                                                        ...
                                                        <DirectEvents>
                                                            <Select OnEvent="GridEmpleados_DblClik" Before="var valid= #{FormPanel1}.getForm().isValid(); if (!valid) {} return valid;">
                                                                <ExtraParams>
                                                                    <ext:Parameter Value="15" Name="ID_Regla" Mode="Value">
                                                                    </ext:Parameter>
                                                                </ExtraParams>
                                                            </Select>
                                                        </DirectEvents>
                        ...
                        <East Collapsible="true">
                            <ext:Panel ID="PnlHeader" runat="server" Title="Parámetros Resultados." Region="Center"
                                ...
                                <Items>
                                    ...
                                    <ext:Label runat="server" ID="Label3" Cls="descripcion" FieldLabel="Parámetros de Salida"
