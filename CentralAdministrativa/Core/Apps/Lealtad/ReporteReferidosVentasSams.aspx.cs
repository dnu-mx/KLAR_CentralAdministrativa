...
namespace Lealtad
{
    public partial class ReporteReferidosVentasSams : DALCentralAplicaciones.PaginaBaseCAPP
    {
        /// <summary>
        ...
        protected void LlenaGridPanelCupones(int RegistroInicial, string Columna, SortDirection Orden)
        {
            ...
            try
            {
                ...
                if (dtCupones == null)
                {
                    dtCupones = DAOPromociones.ObtieneReporteReferidosVentasSams(
                ...
                {
                    X.Msg.Alert("Cupones Referidos Ventas", "No existen coincidencias con la búsqueda solicitada").Show();
                }
                else if (dtCupones.Rows.Count > maxRegistros)
                {
                    X.Msg.Confirm("Cupones Referidos Ventas", "La búsqueda arrojó más de " + maxRegistros.ToString() + " registros.</br>" +
            ...
            {
                X.Msg.Alert("Cupones Referidos Ventas", err.Mensaje()).Show();
            }

            catch (Exception ex)
            {
                DALLealtad.Utilidades.Loguear.Error(ex, this.Usuario.ClaveUsuario);
                X.Msg.Alert("Cupones Referidos Ventas", "Ocurrió un Error al Consultar los Cupones Referidos Ventas").Show();
            }
        ...
        public void ExportDataTableToExcel()
        {
            try
            {
                string reportName = "ReporteReferidosVentasSAMS";
            ...
            {
                DALLealtad.Utilidades.Loguear.Error(ex, this.Usuario.ClaveUsuario);
                X.Msg.Alert("Cupones Referidos Ventas", "Ocurrió un Error al Exportar el Reporte a Excel").Show();
            }
        }
