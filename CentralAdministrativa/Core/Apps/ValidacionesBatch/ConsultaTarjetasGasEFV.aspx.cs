...
{
    public partial class ConsultaTarjetasGasEFV : PaginaBaseCAPP
    {
        /// <summary>
        ...
        protected void PreLoadMainScreenControls()
        {
            ...
            this.StoreAcciones.DataSource = this.StoreAccionesInc.DataSource =
                DAOConsultaTarjetasGasEFV.ListaAcciones(this.Usuario, Guid.Parse(ConfigurationManager.AppSettings["IDApplication"].ToString()));
            this.StoreAcciones.DataBind();
            this.StoreAccionesInc.DataBind();
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet dsEstadisticas = DAOConsultaTarjetasGasEFV.ObtieneEstadisticasTarjeta(estadisticas,
        ...
        protected void InitChkBloqTrajeta()
        {
            ...
            Boolean esAnalista = Boolean.Parse(HttpContext.Current.Session["EsAnalista"].ToString());
             ...
             DataSet dsEstatus = DAOConsultaTarjetasGasEFV.ConsultaEstatusTarjeta(
        ...
        protected void btnBuscarOper_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet dsOperaciones = DAOConsultaTarjetasGasEFV.ObtieneOperacionesPorTarjeta(
        ...
        protected void CellGridResultadosOper_Click(object sender, DirectEventArgs e)
        {
            ...
            if (String.Compare(sm.SelectedCell.Name, "IdComercio") != 0)
            {
                return;
            }
        ...
        protected void btnBuscaInc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet dsIncidencias = DAOConsultaTarjetasGasEFV.ObtieneIncidenciasPorTarjeta(
                    this.hdnTarjeta.Text,
        ...
        protected void VentanaEstacion(String estacion)
        {
            try
            {
                ...
                this.txtComercio.Text = dsAfiliacion.Tables[0].Rows[0]["Estacion"].ToString().Trim();
