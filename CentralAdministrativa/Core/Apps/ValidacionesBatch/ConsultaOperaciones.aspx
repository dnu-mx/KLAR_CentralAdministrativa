<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultaOperaciones.aspx.cs" 
    Inherits="ValidacionesBatch.ConsultaOperaciones" %>
                    ...
                    <ext:Toolbar ID="ToolbarOper" runat="server">
                        <Items>
                            ...
                            <ext:TextField ID="txtTarjeta" runat="server" EmptyText="Tarjeta" AllowBlank="false"
                                Width="160" MaxLength="16" MinLength="16"/>
                            <ext:TextField ID="txtAfiliacionOper" runat="server" EmptyText="Afiliación"
