<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterAngular.Master" CodeBehind="ChartsEfectivale.aspx.cs" Inherits="ValidacionesBatch.ChartsEfetivale" %>

<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
<script src="Content/Components/Efectivale/queriesController.js"></script>

    
    <div ng-controller="QueriesController"  layout="column">
   ...
   <%--         <canvas class="chart chart-bar"
                            chart-data="rData.Values" chart-labels="rData.Labels"
                            chart-series="rData.Series" chart-options="options"
