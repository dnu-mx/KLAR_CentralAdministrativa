<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultaTarjetasGasEFV.aspx.cs"
    Inherits="ValidacionesBatch.ConsultaTarjetasGasEFV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:Window ID="WdwComercio" runat="server" Title="Comercio" Hidden="true" Width="400" Height="270"
        Modal="true" Resizable="false" Closable="true">
        <Items>
            <ext:FormPanel ID="FormPanelComercio" runat="server" Padding="10" MonitorValid="true" LabelAlign="Left">
                <Items>
                    <ext:TextField ID="txtComercio" runat="server" FieldLabel="ID Comercio" ReadOnly="true"
            ...
            <ext:FormPanel ID="FormPanel1" runat="server" Layout="FitLayout">
                <TopBar>
                    <ext:Toolbar ID="Toolbar6" runat="server">
                        <Items>
                            <%--<ext:Toolbar runat="server" Flat="true" Width="300" />--%>
                                            ...
                                            <ext:GridPanel ID="GridResultadosOper" runat="server" Header="true">
                                                        ...
                                                        <Reader>
                                                            <ext:JsonReader IDProperty="ID_Operacion">
                                                                <Fields>
                                                                    ...
                                                                    <ext:RecordField Name="IdComercio" />
                                                ...
                                                <ColumnModel ID="ColumnModel1" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column DataIndex="IdComercio" Header="ID Comercio" Width="80">
                                                            <Renderer Fn="link" />
                                                        </ext:Column>
                                        ...
                                        <North Split="true">
                                            <ext:FormPanel ID="FormPanelBuscaIncidencias" runat="server" LabelWidth="70" LabelAlign="Right">
                                                    ...
                                                    <ext:Toolbar ID="Toolbar4" runat="server">
                                                        <Items>
                                                            ...
                                                            <ext:MultiCombo ID="mCmbAccionInc" runat="server" EmptyText="Acción (Todas)"
                                                                Width="120" ListWidth="120" StoreID="StoreAccionesInc" DisplayField="Accion"
                                                                ValueField="ID_Accion">
                                                                <Listeners>
                                                                    <Select Handler="if (#{mCmbAccionInc}.value != 0) {#{cBoxReglasInc}.setDisabled(false);}
                                                                                    else {#{cBoxReglasInc}.setDisabled(true);}" />
                                                                </Listeners>
                                                            </ext:MultiCombo>
                                                            <ext:ComboBox ID="cBoxReglasInc" runat="server" EmptyText="Regla" Resizable="true" ListWidth="250"
                                                                Width="150" Disabled="true" StoreID="StoreReglasInc" DisplayField="Nombre" ValueField="ID_Regla" />
                                                ...
                                                <Content>
                                                    ...
                                                    <ext:Store ID="StoreAccionesInc" runat="server">
                                                        <Reader>
                                            ...
                                            <ext:GridPanel ID="GridResultadosIncidencias" runat="server" Header="true">
                                                ...
                                                <ColumnModel ID="ColumnModel3" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column DataIndex="Comercio" Header="Comercio" Width="150" />
                    ...
                    <ext:Toolbar ID="ToolbarOper" runat="server">
                        <Items>
                            ...
                            <ext:MultiCombo ID="mCmbAccion" runat="server" EmptyText="Acción (Todas)"
                                ...
                                ValueField="ID_Accion">
                                <Listeners>
                                    <Select Handler="if (#{mCmbAccion}.value != 0) {#{cBoxRegla}.setDisabled(false);}
                                        else {#{cBoxRegla}.setDisabled(true);}" />
                                </Listeners>
                            </ext:MultiCombo>
                            <ext:ComboBox ID="cBoxRegla" runat="server" EmptyText="Regla (Todas)"
                                Width="120" Disabled="true" ListWidth="120" StoreID="StoreReglas"
                                DisplayField="Nombre" ValueField="ID_Regla" />
