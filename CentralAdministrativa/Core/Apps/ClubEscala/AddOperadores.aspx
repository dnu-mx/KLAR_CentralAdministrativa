<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="AddOperadores.aspx.cs" Inherits="OperadoraWeb.AddOperadores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <West Split="true">
            <ext:FormPanel ID="FormPanel1" Width="350" Title="Agregar Operadores" runat="server"
                ...
                <Items>
                    <ext:TabPanel runat="server" ActiveTabIndex="0" TabPosition="Bottom" Border="false"
                        ...
                        <Items>
                            <ext:Panel ID="Panel1" runat="server" Title="Nuevo Operador" AutoHeight="true" FormGroup="true">
                                <Content>
