<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ColectivaEditar.aspx.cs" Inherits="ClubEscala.ColectivaEditar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        ...
        <East Split="true">
            ...
            <ext:FormPanel ID="FormPanel1" Width="428.5" Title="Mi Grupo Comercial" runat="server" Collapsed="true" Collapsible="true"
                    ...
                    <ext:TabPanel runat="server" ActiveTabIndex="0" TabPosition="Bottom" Border="false"
                        ...
                        <Items>
                            <ext:Panel ID="Panel1" runat="server" Title="Datos de Sesion" AutoHeight="true"  FormGroup="true">
                                ...
                                <Items>
                                    <ext:TextField ID="txtUserName" Enabled="false"  Disabled ="true" FieldLabel="Clave Usuario" AllowBlank="false" MsgTarget="Side"
                                        MaxLength="50" runat="server" Text="" Width="400" />
                                    <ext:TextField ID="txtPass1" FieldLabel="Password" Visible="false" AllowBlank="false" MsgTarget="Side"
                                        MaxLength="20" InputType="Password" runat="server" Width="400" Text="" />
                                    <ext:TextField ID="txtPass2" FieldLabel="Repite Password" Visible="false" AllowBlank="false" MsgTarget="Side"
                                        MaxLength="20" InputType="Password" runat="server" Text="" Width="400" />
                                    <ext:ComboBox ID="cmbTipoUsuario" EmptyText="Selecciona una Opción"   Enabled="false" Disabled ="true" FieldLabel="Tipo Colectiva" AllowBlank="false"
                                    ...
                                    <ext:ComboBox ID="cmbPadreTipoColectiva"  EmptyText="Selecciona una Opción"  Enabled="false" Disabled ="true" FieldLabel="Colectiva Padre" AllowBlank="false"
                                        MsgTarget="Side" runat="server" Width="400" StoreID="SCPadre" DisplayField="NombreORazonSocial"
                                        ValueField="ID_Colectiva">
                                    </ext:ComboBox>
                                    <ext:TextField ID="txtNombre" FieldLabel="Nombre/RS" AllowBlank="false"
                                    ...
                                    <ext:TextField ID="txtMovil"  Enabled="false" FieldLabel="Telefono Movil" AllowBlank="true" MsgTarget="Side"
                                    ...
                                    <ext:TextField ID="txtemail2"  Enabled="false" FieldLabel="Email" Disabled ="true" AllowBlank="true" MsgTarget="Side"
                                        MaxLength="50" runat="server" Text="" Width="400" />
                                          <ext:ComboBox ID="cmbAfiliacion" FieldLabel="Afiliación Transacccional" EmptyText="Selecciona una Opción" AllowBlank="false"
                                        MsgTarget="Side" runat="server"  StoreID="SAfiliaciones" DisplayField="NombreAfiliacion"
                            ...
                            <ext:Panel ID="Panel8" runat="server" Title="Direccion Ubicación" AutoHeight="true"
                                ...
                                <Items>
                                    ...
                                    <ext:ComboBox ID="UcmbEstado" EmptyText="Selecciona una Opción"  FieldLabel="Estado" MsgTarget="Side" runat="server"
                                    ...
                                    <ext:ComboBox ID="UcmbMunicipios" EmptyText="Selecciona una Opción"  FieldLabel="Municipio" MsgTarget="Side"
                                    ...
                                    <ext:ComboBox ID="UcmbAsentamiento" EmptyText="Selecciona una Opción"  FieldLabel="Asentamiento" MsgTarget="Side" runat="server"
                            ...
                            <ext:Panel ID="Panel9" runat="server" Title="Dirección Facturación" AutoHeight="true"
                                ...
                                <Items>
                                    ...
                                    <ext:ComboBox ID="fcmbEstado"  EmptyText="Selecciona una Opción" runat="server" FieldLabel="Estado" Width="400" StoreID="SFEdo"
                                    ...
                                    <ext:ComboBox ID="FcmbMunicipio" EmptyText="Selecciona una Opción"  FieldLabel="Municipio" runat="server"
                                    ...
                                    <ext:ComboBox ID="FcmbAsentamiento" EmptyText="Selecciona una Opción"  FieldLabel="Asentamiento" runat="server" Width="400"
