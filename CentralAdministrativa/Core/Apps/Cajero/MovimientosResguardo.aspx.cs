...
namespace Cajero
{
    public partial class MovimientosResguardo : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        private void BindData()
        {
            ...
            GridPanel1.GetStore().DataSource = DAOMovimiento.ListaMovimientosResguardo(this.Usuario, Guid.Parse(ConfigurationManager.AppSettings["IdApplication"].ToString()));
        ...
        public void AsignarOperacion()
        {
            try
            {
                ...
                laRespuesta=LNAsignacion.Asignar(Id_Movimiento, Id_Ficha, elUser, enumTipoAsignacion.AdministradorSeleccionaAmbos, Guid.Parse(ConfigurationManager.AppSettings["IdApplication"].ToString()));
