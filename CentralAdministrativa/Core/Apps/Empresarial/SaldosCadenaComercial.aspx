<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SaldosCadenaComercial.aspx.cs" Inherits="Empresarial.SaldosCadenaComercial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        <Center Split="true">
            <ext:Panel ID="Panel1" runat="server" Width="428.5" Title="Cadenas Comerciales"
        ...
        <East Split="true">
            <ext:Panel ID="Panel5" runat="server" Width="850" Title="Cuentas del Cadenas Comercial"
