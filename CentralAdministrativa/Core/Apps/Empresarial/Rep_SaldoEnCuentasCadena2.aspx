<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"
    CodeBehind="Rep_SaldoEnCuentasCadena2.aspx.cs" Inherits="Empresarial.Rep_SaldoEnCuentasCadena2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        ...
        <East Split="true">
            <ext:Panel ID="pnlDetalles" runat="server" Width="550" Title="Detalles"
                ...
                <Content>
                    <ext:BorderLayout ID="BorderLayout3" runat="server">
                            ...
                            <ext:Panel ID="Panel12" runat="server" Height="450" Width="450" Layout="FitLayout" LabelWidth="85"
                                ...
                                <Items>
                                    <ext:GridPanel ID="GridDetalle" runat="server" Title="Cuentas" StripeRows="true" Header="false"
                                        Border="false" AutoScroll="true" AutoDoLayout="true" >
                                        <Store>
                        ...
                        <South Split="true">
                            <ext:Panel ID="PanelDetallePoliza" runat="server" Width="450" Height="150" Title="Detalle Póliza" 
