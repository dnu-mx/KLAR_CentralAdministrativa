<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"
    CodeBehind="ReporteSaldosCuentasEje.aspx.cs" Inherits="Empresarial.ReporteSaldosCuentasEje" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
            ...
            <ext:Panel ID="pnlcuentas" runat="server" Width="850" Title="Saldos" Collapsed="false"
                ...
                <Content>
                    <ext:BorderLayout ID="BorderLayout2" runat="server">
                        <Center Split="true">
                            <ext:GridPanel ID="GridPanelCuentasEje" runat="server" StripeRows="true" Header="false" Border="false">
                                <%--<LoadMask ShowMask="true" />--%>
                                <Store>
                                    <ext:Store ID="StoreCuentasEje" runat="server" RemoteSort="true" OnRefreshData="StoreCuentasEje_RefreshData"
                                ...
                                <BottomBar>
                                    <ext:PagingToolbar ID="PagingSaldosCuentasEje" runat="server" StoreID="StoreCuentasEje" DisplayInfo="true"
        ...
        <East Split="true">
            <ext:Panel ID="pnlDetalleCuentaEje" runat="server" Width="550" Collapsed="true" Collapsible="true"
                Layout="FitLayout" AutoScroll="true">
                <Content>
                    <ext:Hidden ID="hdnIdCuentaEje" runat="server" />
                    <ext:BorderLayout ID="BorderLayout3" runat="server">
                        <Center Split="true">
                            <ext:Panel ID="Panel12" runat="server" Height="450" Width="450" Layout="FitLayout" LabelWidth="85"
                                            ...
                                            <ext:Button ID="btnBuscar" runat="server" Text="Buscar..." ToolTip="Buscar Detalles del Periodo"
                                                ...
                                                <DirectEvents>
                                                    <Click OnEvent="btnBuscar_Click" Timeout="360000"
                                                        Before="resetToolbar(#{PagingDetSaldosCE});
                                                        #{GridDetalleCuentasEje}.getStore().sortInfo = null;">
                                                    </Click>
                                                </DirectEvents>
                                            </ext:Button>
                                            <ext:Button ID="btnBuscarDetalleCEHide" runat="server" Hidden="true">
                                                <Listeners>
                                                    <Click Handler="Ext.net.Mask.show({ msg : 'Obteniendo Detalle de Movimientos...' });
                                                        #{GridDetalleCuentasEje}.getStore().reload({params:{start:0, sort:('','')}});" />
                                                </Listeners>
                                            </ext:Button>
                                            <ext:Button ID="btnDownloadDetCE" runat="server" Hidden="true">
                                                <DirectEvents>
                                                    <Click OnEvent="DownloadDetalleCuentaEje" IsUpload="true"
                                                        After="Ext.net.Mask.show({ msg : 'Exportando Reporte a Excel...' });
                                                        RepSaldosCuentasEje.StopMask();" />
                                                </DirectEvents>
                                            </ext:Button>
                                ...
                                <Items>
                                    <ext:GridPanel ID="GridDetalleCuentasEje" runat="server" Title="Cuentas" StripeRows="true" Header="false"
                                        Border="false" Layout="FitLayout" AutoScroll="true">
                                        <Store>
                                            <ext:Store ID="StoreDetalleCuentaEje" runat="server" RemoteSort="true" AutoLoad="false"
                                                OnRefreshData="StoreDetalleCuentaEje_RefreshData">
                                                <AutoLoadParams>
                                        ...
                                        <TopBar>
                                            <ext:Toolbar runat="server">
                                                <Items>
                                                    <ext:ToolbarFill runat="server" />
                                                    <ext:ToolbarSeparator runat="server" />
                                                    <ext:Button ID="btnExportDetCuentaEjeExcel" runat="server" Text="Exportar a Excel" Icon="PageExcel" 
                                ...
                                <BottomBar>
                                    <ext:PagingToolbar ID="PagingDetSaldosCE" runat="server" StoreID="StoreDetalleCuentaEje" DisplayInfo="true"
