<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"
    CodeBehind="ReporteSaldosCuentasEmisor.aspx.cs" Inherits="Empresarial.ReporteSaldosCuentasEmisor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
            ...
            <ext:Panel ID="pnlcuentas" runat="server" Width="850" Title="Saldos" Collapsed="false"
                ...
                <Content>
                    <ext:BorderLayout ID="BorderLayout2" runat="server">
                        <Center Split="true">
                            <ext:GridPanel ID="GridPanelCuentasEmisor" runat="server" StripeRows="true" Header="false" Border="false">
                                <Store>
                                    <ext:Store ID="StoreCuentasEmisor" runat="server" RemoteSort="true" OnRefreshData="StoreCuentasEmisor_RefreshData"
                                ...
                                <BottomBar>
                                    <ext:PagingToolbar ID="PagingSaldosCuentasEmisor" runat="server" StoreID="StoreCuentasEmisor" DisplayInfo="true"
                                            ...
                                            <ext:Button ID="btnDownloadHide" runat="server" Hidden="true">
                                                <DirectEvents>
                                                    <Click OnEvent="Download" IsUpload="true"
                                                        ...
                                                        RepSaldosCuentasEmisor.StopMask();" />
                                                </DirectEvents>
                                            </ext:Button>
                                        </Items>
                                    </ext:PagingToolbar>
        ...
        <East Split="true">
            <ext:Panel ID="pnlDetalleCtaEmisor" runat="server" Width="550" Collapsed="true" Collapsible="true"
                Layout="FitLayout" AutoScroll="true">
                <Content>
                    <ext:Hidden ID="hdnIdCuentaEmisor" runat="server" />
                    <ext:BorderLayout ID="BorderLayout3" runat="server">
                        <Center Split="true">
                            <ext:Panel ID="Panel12" runat="server" Height="450" Width="450" Layout="FitLayout" LabelWidth="85"
                                            ...
                                            <ext:Button ID="btnBuscar" runat="server" Text="Buscar..." ToolTip="Buscar Detalles del Periodo"
                                                ...
                                                <DirectEvents>
                                                    <Click OnEvent="btnBuscar_Click" Timeout="360000"
                                                        Before="resetToolbar(#{PagingDetSCEmisor});
                                                        #{GridDetalleCuentasEmisor}.getStore().sortInfo = null;">
                                                    </Click>
                                                </DirectEvents>
                                            </ext:Button>
                                            <ext:Button ID="btnBuscarDetalleCEHide" runat="server" Hidden="true">
                                                <Listeners>
                                                    <Click Handler="Ext.net.Mask.show({ msg : 'Obteniendo Detalle de Movimientos...' });
                                                        #{GridDetalleCuentasEmisor}.getStore().reload({params:{start:0, sort:('','')}});" />
                                                </Listeners>
                                            </ext:Button>
                                            <ext:Button ID="btnDownloadDetCEm" runat="server" Hidden="true">
                                                <DirectEvents>
                                                    <Click OnEvent="DownloadDetalleCtaEmisor" IsUpload="true"
                                                        After="Ext.net.Mask.show({ msg : 'Exportando Reporte a Excel...' });
                                                        RepSaldosCuentasEmisor.StopMask();" />
                                                </DirectEvents>
                                            </ext:Button>
                                ...
                                <Items>
                                    <ext:GridPanel ID="GridDetalleCuentasEmisor" runat="server" Title="Cuentas" StripeRows="true" Header="false"
                                        Border="false" Layout="FitLayout" AutoScroll="true">
                                        <Store>
                                            <ext:Store ID="StoreDetalleCuentasEmisor" runat="server" RemoteSort="true" AutoLoad="false"
                                                OnRefreshData="StoreDetalleCuentasEmisor_RefreshData">
                                                <AutoLoadParams>
                                        ...
                                        <TopBar>
                                            <ext:Toolbar runat="server">
                                                <Items>
                                                    <ext:ToolbarFill runat="server" />
                                                    <ext:ToolbarSeparator runat="server" />
                                                    <ext:Button ID="btnExportDetCtaEmisorExcel" runat="server" Text="Exportar a Excel" Icon="PageExcel" 
                                ...
                                <BottomBar>
                                    <ext:PagingToolbar ID="PagingDetSCEmisor" runat="server" StoreID="StoreDetalleCuentasEmisor" DisplayInfo="true"
                            ...
                            <ext:Panel ID="PanelDetallePoliza" runat="server" Width="450" Height="150" Title="Detalle Póliza" Collapsed="true"
                                ...
                                <Items>
                                    <ext:GridPanel ID="GridDetallePoliza" runat="server" StripeRows="true" Header="false"
                                        ...
                                        <Store>
                                            <ext:Store ID="StoreDetallePolizaCtaEm" runat="server">
                                                <DirectEventConfig IsUpload="true" />
                                                <Reader>
