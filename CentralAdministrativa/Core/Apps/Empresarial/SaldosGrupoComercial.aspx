<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SaldosGrupoComercial.aspx.cs" Inherits="Empresarial.SaldosGrupoComercial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        <Center Split="true">
            <ext:Panel ID="Panel1" runat="server" Width="428.5" Title="Grupos Comerciales"
                            ...
                            <ext:GridPanel ID="GridPanel2" runat="server" StoreID="Store2" StripeRows="true"
                                ...
                                <BottomBar>
                                    <ext:PagingToolbar ID="PagingToolBar2" runat="server" StoreID="Store2" DisplayInfo="true"
                                        DisplayMsg="Mostrando Grupos Comerciales {0} - {1} de {2}" />
                                </BottomBar>
                            </ext:GridPanel>
                        </Center>
                    </ext:BorderLayout>
