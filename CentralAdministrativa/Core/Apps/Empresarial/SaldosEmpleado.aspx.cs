...
{
    public partial class SaldosEmpleado : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        private void BindDataEmpleados()
        {
            ...
            GridPanel2.GetStore().DataSource = DAOCatalogos.ListaEmpleadosMiembrosClubGrupoComercial(-1, 
                Configuracion.Get(IDApp, "ClaveTipoColectivaEmpleado").Valor, this.Usuario, 
        ...
        protected void GridEmpleados_DblClik(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                Panel5.Title = "Saldos en Cuentas Empleado No. [" + unvalor + "]";
