<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="CuentasBancarias_V1.aspx.cs" Inherits="Administracion.CuentasBancarias_V1" %>
                    ...
                    <ext:BorderLayout ID="BorderLayout1" runat="server">
                        <Center>
                            <ext:TabPanel ID="TabPanel1" runat="server">
                                <Items>
                                    <ext:FormPanel ID="FormPanelTitular" runat="server" Title="Titular" LabelAlign="Left" LabelWidth="150" >
                                        <Content>
                                        ...
                                        <Items>
                                            <ext:FieldSet ID="FieldSetDatosTitular" runat="server" Border="false" >
                                                <Items>
                                                    ...
                                                    <ext:TextField ID="txtTarjetaTitular" runat="server" FieldLabel="Número de Tarjeta" MaxLength="16" Width="550" 
                                                    ...
                                                    <ext:Panel ID="PanelDatosPersonales" runat="server" Title="Datos Personales" AutoHeight="true" LabelAlign="Left"
                                                        ...
                                                        <Items>
                                                            <ext:TextField ID="txtNombreClienteTitular" runat="server" FieldLabel="Nombre" Width="395" AllowBlank="false" />
                                                            <ext:TextField ID="txtApPaternoTitular" runat="server" FieldLabel="Primer Apellido" MaxLength="30" Width="395" AllowBlank="false" />
                                                            <ext:TextField ID="txtApMaternoTitular" runat="server" FieldLabel="Segundo Apellido" MaxLength="30" Width="395" />
                                                            <ext:TextField ID="txtRFCTitular" runat="server" FieldLabel="RFC" MaxLength="13" Width="395" />
                                                        </Items>
                                                    </ext:Panel>
                                                    ...
                                                    <ext:Panel ID="PanelDomicilio" runat="server" Title="Domicilio" AutoHeight="true" LabelAlign="Left"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:TextField ID="txtCalle" runat="server" FieldLabel="Calle" MaxLength="30" Width="395" />
                                                            <ext:TextField ID="txtNumExterior" runat="server" FieldLabel="Número Exterior"
                                                                MaxLength="6" Width="395" />
                                                            ...
                                                            <ext:TextField ID="txtCPCliente" runat="server" FieldLabel="Código Postal"
                                                                MinLength="5" MaxLength="5" Width="395" EnableKeyEvents="true">
                                                                <Listeners>
                                                            ...
                                                            <ext:ComboBox ID="cBoxColonia" runat="server" FieldLabel="Colonia" StoreID="StoreColonias" 
                                                                Width="395" DisplayField="Colonia" ValueField="ID_Colonia" />
                                                    ...
                                                    <ext:Panel ID="PanelDatosContacto" runat="server" Title="Datos de Contacto" AutoHeight="true" LabelAlign="Left"
                                                        FormGroup="true" Layout="FormLayout" Width="600px" >
                                                        <Items>
                                                            <ext:NumberField ID="nfTelParticular" runat="server" FieldLabel="Teléfono Particular" MaxLength="10" Width="395"
                                                                AllowDecimals="False" AllowNegative="False" />
                                                            <ext:NumberField ID="nfTelCelular" runat="server" FieldLabel="Teléfono Celular" MaxLength="10" Width="395"
                                                                AllowDecimals="False" AllowNegative="False" />
                                                            <ext:NumberField ID="nfTelTrabajo" runat="server" FieldLabel="Teléfono Trabajo" MaxLength="10" Width="395"
                                                                AllowDecimals="False" AllowNegative="False" />
                                                            <ext:TextField ID="txtCorreo" runat="server" FieldLabel="Correo Electrónico" MaxLength="30" Width="395" />
                                                        </Items>
                                                    </ext:Panel>
                                                </Items>
                                                <Buttons>
