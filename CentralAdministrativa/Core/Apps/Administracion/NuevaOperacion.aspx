<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="NuevaOperacion.aspx.cs" Inherits="Administracion.NuevaOperacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ext:BorderLayout ID="MainBorderLayout" runat="server">
        ...
        <Center Split="true">
            <%--<ext:FormPanel ID="FormPanelNuevoEvento" runat="server" Width="428.5" Title="Evento" Border="false" Layout="Fit">
                <Content>
                    <ext:Store ID="StoreTipoEvento" runat="server">
                        <Reader>
                            <ext:JsonReader IDProperty="ID_TipoEvento">
                ...
                <Items>
                    <ext:FormPanel ID="SubNuevoEvento" runat="server" Border="false" Header="false" Width="500px"
                        LabelAlign="Left" Layout="FormLayout">
                        <Items>
                            <ext:Panel ID="Panel1" runat="server" Title="Datos Generales" AutoHeight="true" LabelAlign="Top"
                            ...
                            <ext:Panel ID="Panel4" runat="server" Title="Datos Lógicos" AutoHeight="true" LabelAlign="Top"
                                FormGroup="true" Layout="TableLayout" Width="500px">
                                <Items>
                                    <ext:Panel ID="Panel5" runat="server" Border="false" Header="false" Width="200px"
                                        ColumnWidth=".5" Layout="Form" LabelAlign="Top">
                                        <Items>
                                            <ext:SelectBox ID="sBoxActivo" runat="server" FieldLabel="Activo" AllowBlank="false"
                                                AnchorHorizontal="90%" TabIndex="1">
                                    ...
                                    <ext:Panel ID="Panel6" runat="server" Border="false" Header="false" ColumnWidth=".5"
                                        Width="200px" Layout="Form" LabelAlign="Top">
                                        <Items>
                                            <ext:SelectBox ID="sBoxReversable" runat="server" FieldLabel="Reversable" AllowBlank="false"
                                                AnchorHorizontal="90%" TabIndex="2">
                            ...
                            <ext:Panel ID="Panel7" runat="server" Title="Estado de Cuenta" AutoHeight="true" LabelAlign="Top"
                                FormGroup="true" Layout="TableLayout" Width="500px">
                                <Items>
                                    <ext:Panel ID="Panel8" runat="server" Border="false" Header="false" Width="430px"
                                        ColumnWidth=".5" Layout="Form" LabelAlign="Top">
                                        <Items>
                                            <ext:TextArea ID="txtDescripcionEdoCta" runat="server" FieldLabel="Descripción"
                                                BoxLabel="CheckBox" Height="100" AllowBlank="false" MaxLength="150"
                                                AnchorHorizontal="95%" TabIndex="1" />
                                        </Items>
                                    </ext:Panel>
                                </Items>
