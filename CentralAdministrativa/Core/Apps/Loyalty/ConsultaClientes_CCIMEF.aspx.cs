...
{
    public partial class ConsultaClientes_CCIMEF : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        protected void LlenarGridResultados()
        {
            try
            {
                ...
                DataSet dsResultados = LNClientesCCIMEF.ConsultaClientes(elCliente, this.Usuario);
            ...
            try
            {
                ...
                switch (Formulario)
                {
                    case (ushort)AccionBitacora.CambioContrasena:
                        Accion = "Ajuste Manual Clientes CCIMEF - Cambio de Contraseña";
                        break;

                    case (ushort)AccionBitacora.CambioEstatus:
                        Accion = "Ajuste Manual Clientes CCIMEF - Confirmación de Correo";
                        break;

                    case (ushort)AccionBitacora.Bloqueo:
                        Accion = "Ajuste Manual Clientes CCIMEF - Bloqueo/Desbloqueo";
                        break;

                    case (ushort)AccionBitacora.CambioMembresia:
                        Accion = "Ajuste Manual Clientes CCIMEF - Cambio de Membresia";
                        break;
        ...
        protected void LlenaFieldSetDatosCliente(int idcliente, int idcolectiva, int idtipocolectiva, String eMail)
        {
            ...
            {
                FormPanelDatos.Reset();
                DataSet dsDatos = DAOConsultaClientesCCIMEF.ObtieneDatosCliente(idcliente, idcolectiva, this.Usuario);
                ...
                dsDatos = DAOConsultaClientesCCIMEF.ObtieneBloqueoCliente(eMail, this.Usuario);
                string bloqueo;
        ...
        protected void btnGuardarEstatus_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    LNClientesCCIMEF.ActualizaEstatusConfirmaClientes(Convert.ToInt32(cboEstatusConfirma.Value), Convert.ToInt32(this.hdID_Colectiva.Text), this.Usuario);
        ...
        protected void btnGenerarContrasena_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.hdeMail.Text != "")
                {
                    ...
                    LNClientesCCIMEF.GenerarContrasenaClientes(Convert.ToInt32(this.hdID_Colectiva.Text), this.hdeMail.Text, contrasena, this.Usuario);
        ...
        protected void btnAplicarBloqueo_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.hdeMail.Text != "")
                {
                    ...
                    LNClientesCCIMEF.AplicaBloqueoContracargoCliente(this.hdeMail.Text, rdBloqueado.Checked, txtComentario.Text, this.Usuario);
        ...
        protected void btnCambiarMembresia_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    LNClientesCCIMEF.AplicaCambioMembresia(this.hdeMail.Text, this.txtMembresiaNew.Text, this.Usuario);
