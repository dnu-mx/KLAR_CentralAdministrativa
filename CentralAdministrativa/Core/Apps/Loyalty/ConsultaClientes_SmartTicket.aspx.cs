...
{
    public partial class ConsultaCtes_Smart : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        protected void LlenarGridResultados()
        {
            try
            {
                ...
                DataSet dsResultados = LNClientesSmartTicket.ConsultaClientes(elCliente, this.Usuario);
            ...
            try
            {
                ...
                switch (Formulario)
                {
                    case (ushort)AccionBitacora.CambioContrasena:
                        Accion = "Ajuste Manual SmartTicket - Cambio de Contraseña";
                        break;

                    case (ushort)AccionBitacora.CambioEstatus:
                        Accion = "Ajuste Manual SmartTicket - Confirmación de Correo";
                        break;

                    case (ushort)AccionBitacora.Bloqueo:
                        Accion = "Ajuste Manual SmartTicket - Bloqueo/Desbloqueo";
                        break;
        ...
        protected void LlenaFieldSetDatosCliente(int idcliente, int idcolectiva, int idtipocolectiva, String eMail)
        {
            ...
            {
                FormPanelDatos.Reset();
                DataSet dsDatos = DAOConsultaClientesSmartTicket.ObtieneDatosCliente(idcliente, idcolectiva, this.Usuario);
                ...
                dsDatos = DAOConsultaClientesSmartTicket.ObtieneBloqueoCliente(eMail, this.Usuario);
                string bloqueo;
        ...
        protected void btnBuscarPed_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dsPedidos = LNClientesSmartTicket.ConsultaPedidos(
        ...
        protected void btnGuardarEstatus_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    LNClientesSmartTicket.ActualizaEstatusConfirmaClientes(Convert.ToInt32(cboEstatusConfirma.Value), Convert.ToInt32(this.hdID_Colectiva.Text), this.Usuario);
        ...
        protected void btnGenerarContrasena_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.hdeMail.Text != "")
                {
                    ...
                    LNClientesSmartTicket.GenerarContrasenaClientes(Convert.ToInt32(this.hdID_Colectiva.Text), this.hdeMail.Text, contrasena, this.Usuario);
        ...
        protected void btnAplicarBloqueo_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.hdeMail.Text != "")
                {
                    ...
                    LNClientesSmartTicket.AplicaBloqueoContracargoCliente(this.hdeMail.Text, rdBloqueado.Checked, txtComentario.Text, this.Usuario);
