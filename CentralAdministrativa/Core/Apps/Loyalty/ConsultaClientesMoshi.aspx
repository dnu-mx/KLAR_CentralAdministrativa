<%@ Page Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="ConsultaClientesMoshi.aspx.cs" Inherits="CentroContacto.ConsultaClientesMoshi" %>
                        ...
                        <Center>
                            <ext:TabPanel ID="TabPanel1" runat="server">
                                <Items>
                                    <ext:FormPanel ID="FormPanelDatos" runat="server" Title="Datos" LabelAlign="Left" LabelWidth="200">
                                        <Content>
                                            <ext:Store ID="StoreEmpresas" runat="server">
                                                <Reader>
                                                    <ext:JsonReader IDProperty="ClaveEmpresa">
                                                        <Fields>
                                                            <ext:RecordField Name="ClaveEmpresa" />
                                        ...
                                        <Items>
                                            <ext:FieldSet ID="FieldSetDatosCliente" runat="server" Title="Información del Cliente">
                                                <Items>
                                                    ...
                                                    <ext:TextField ID="txtNombreCliente" runat="server" FieldLabel="Nombre" Width="500" MaxLength="30"
                                                        AllowBlank="false" />
                                                    <ext:TextField ID="txtApPaternoCliente" runat="server" FieldLabel="Primer Apellido" MaxLength="30"
                                                        Width="500" AllowBlank="false" />
                                                    <ext:TextField ID="txtApMaternoCliente" runat="server" FieldLabel="Segundo Apellido" MaxLength="30"
                                                        Width="500" />
                                                    ...
                                                    <ext:DateField ID="dfFechaNacCliente" runat="server" FieldLabel="Fecha de Nacimiento"
                                                        Format="dd/MM/yyyy" Width="500" AllowBlank="false" />
                                                    <ext:TextField ID="txtVisitas" runat="server" FieldLabel="Visitas del año" Width="500"
                                                        ReadOnly="true" Enabled="false" />
                                                    ...
                                                    <ext:DateField ID="dfFechaAltaLealtad" runat="server" FieldLabel="Fecha de alta Lealtad"
                                                        Format="dd/MM/yyyy" Width="500" ReadOnly="true" Enabled="false" />
                                                    <ext:TextField ID="txtNivelLealtad" runat="server" FieldLabel="Nivel Lealtad" MaxLength="30"
                                                        Width="500" ReadOnly="true" Enabled="false" />
                                                    <ext:TextField ID="txtcorreoEmpresa" runat="server" FieldLabel="Correo Trabajo" MaxLength="30"
                                                        Width="500" ReadOnly="false" />
                                                    <ext:ComboBox ID="ComboEmpresa" runat="server" FieldLabel="Empresa" Width="500"
                                                        ListWidth="350" StoreID="StoreEmpresas" DisplayField="NombreComercial"
                                                        ValueField="ClaveEmpresa" />
                                                    <ext:TextField ID="txtlugarTrabajo" runat="server" FieldLabel="Lugar trabajo" MaxLength="30"
                                                        Width="500" ReadOnly="false" />
                                                </Items>
                                                <Buttons>
                                    ...
                                    <ext:FormPanel ID="FormPanelDirecciones" runat="server" Title="Direcciones" LabelAlign="Left" LabelWidth="200">
                                        <Content>
                                    ...
                                    <ext:FormPanel ID="FormPanelPedidos" runat="server" Title="Pedidos">
                                        <Content>
                                                ...
                                                <Center Split="true">
                                                    <ext:GridPanel ID="GridResultadosMovLeal" runat="server" Header="true" Title="Saldo: ">
                                                        ...
                                                        <ColumnModel ID="ColumnModel3" runat="server">
                                                            <Columns>
                                                                <ext:DateColumn DataIndex="Fecha" Header="Fecha del Servicio" Align="Center" Format="dd-MMM-yyyy HH:mm:ss" Width="120" />
                                    ...
                                    <ext:FormPanel ID="FormPanelAjustesManuales" runat="server" Title="Ajustes Manuales" LabelAlign="Left" LabelWidth="120">
                                        ...
                                        <Items>
                                            <ext:FieldSet ID="FieldSetAjustesManuales" runat="server" Title="Cambio de Nivel" Layout="AnchorLayout"
                                                ...
                                                <Buttons>
                                                    <ext:Button ID="btnGuardarNivel" runat="server" Text="Guardar" Icon="Disk">
                                                        <DirectEvents>
                                                            <Click OnEvent="btnGuardarNivel_Click" />
                                                        </DirectEvents>
                                                    </ext:Button>
                                                </Buttons>
                                            </ext:FieldSet>
                                            ...
                                            <ext:FieldSet ID="FieldSetCargaVisitas" runat="server" Title="Carga de Visitas" Layout="AnchorLayout"
                                                DefaultAnchor="100%" Collapsible="true" Collapsed="true">
                                                <Items>
                                                    <ext:NumberField ID="nfCargaVisitas" runat="server" FieldLabel="Número de Visitas" MaxLength="5" Width="500"
                                                        AllowDecimals="false" AllowNegative="false" AllowBlank="false" />
                                                    <ext:TextArea ID="txtObsCargaV" runat="server" FieldLabel="Observaciones" MaxLength="500"
                                                        MaxLengthText="500" AllowBlank="false" />
                                                </Items>
                                                <Buttons>
                                                    <ext:Button ID="btnAplicaCargaV" runat="server" Text="Aplicar" Icon="ControlRemoveBlue">
                                                        <DirectEvents>
                                                            <Click OnEvent="btnAplicaCargaV_Click" Before="var valid1= #{nfCargaVisitas}.isValid(); 
                                                                 var valid2= #{txtObsCargaV}.isValid(); if (!valid1 || !valid2) {} return valid1;" />
                                                        </DirectEvents>
                                                    </ext:Button>
                                                </Buttons>
                                            </ext:FieldSet>
                                            <ext:FieldSet ID="FieldSetAbonoVisitas" runat="server" Title="Abono de Visitas" Layout="AnchorLayout"
                                                DefaultAnchor="100%" Collapsible="true" Collapsed="true">
                                                <Items>
                                                    <ext:NumberField ID="nfAbonoVisitas" runat="server" FieldLabel="Número de Visitas" MaxLength="5" Width="500"
                                                        AllowDecimals="false" AllowNegative="false" AllowBlank="false" />
                                                    <ext:TextArea ID="txtObsAbonoV" runat="server" FieldLabel="Observaciones" MaxLength="500"
                                                        MaxLengthText="500" AllowBlank="false" />
                                                </Items>
                                                <Buttons>
                                                    <ext:Button ID="btnAplicaAbonoV" runat="server" Text="Aplicar" Icon="ControlAddBlue">
                                                        <DirectEvents>
                                                            <Click OnEvent="btnAplicaAbonoV_Click" Before="var valid1= #{nfAbonoVisitas}.isValid(); 
                                                                 var valid2= #{txtObsAbonoV}.isValid(); if (!valid1 || !valid2) {} return valid1;" />
                                                        </DirectEvents>
                                                    </ext:Button>
                                                </Buttons>
                                            </ext:FieldSet>
