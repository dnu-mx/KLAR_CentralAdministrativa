...
{
    public partial class ConsultaTarjetas_SmartTicketCinemex : DALCentralAplicaciones.PaginaBaseCAPP
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    StoreEstatus.DataSource = DAOConsultaTarjetasSmartTicketCinemex.ListaCatalogoEstatusTarjeta(this.Usuario);
        ...
        protected void LlenarGridResultados()
        {
            try
            {
                ...
                DataSet dsResultados = LNTarjetasSmartTicketCinemex.ConsultaClientes(elCliente, this.Usuario);
        ...
        protected void LlenaGridPanelTarjetas(int idcliente)
        {
            try
            {
                ...
                DataSet dsTarjetas = DAOConsultaTarjetasSmartTicketCinemex.ObtieneTarjetasCliente(idcliente, this.Usuario);
        ...
        public void ActualizaEstatusTarjeta(int IdTarjeta, string Valor)
        {
            try
            {
                LNTarjetasSmartTicketCinemex.ModificaEstatusTarjeta(IdTarjeta, int.Parse(Valor), this.Usuario);
