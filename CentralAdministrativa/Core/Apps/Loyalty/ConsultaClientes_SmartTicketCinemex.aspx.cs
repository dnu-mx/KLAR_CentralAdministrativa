...
{
    public partial class ConsultaClientes_SmartTicketCinemex : DALCentralAplicaciones.PaginaBaseCAPP
    {
        #region Variables privadas

        protected enum AccionBitacora
        {
            CambioContrasena = 1043,
            CambioEstatus = 1042,
            Bloqueo = 1044
        };
        ...
        protected void LlenarGridResultados()
        {
            try
            {
                ...
                DataSet dsResultados = LNClientesSmartTicketCinemex.ConsultaClientes(elCliente, this.Usuario);
            ...
            try
            {
                ...
                switch (Formulario)
                {
                    case (ushort)AccionBitacora.CambioContrasena:
                        Accion = "Ajuste Manual SmartTicket Cinemex - Cambio de Contraseña";
                        break;

                    case (ushort)AccionBitacora.CambioEstatus:
                        Accion = "Ajuste Manual SmartTicket Cinemex - Confirmación de Correo";
                        break;

                    case (ushort)AccionBitacora.Bloqueo:
                        Accion = "Ajuste Manual SmartTicket Cinemex - Bloqueo/Desbloqueo";
                        break;
        ...
        protected void LlenaFieldSetDatosCliente(int idcliente, int idcolectiva, int idtipocolectiva, String eMail)
        {
            ...
            {
                FormPanelDatos.Reset();
                DataSet dsDatos = DAOConsultaClientesSmartTicketCinemex.ObtieneDatosCliente(idcliente, idcolectiva, this.Usuario);
                ...
                dsDatos = DAOConsultaClientesSmartTicketCinemex.ObtieneBloqueoCliente(eMail, this.Usuario);
                string bloqueo;
        ...
        protected void btnBuscarPed_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dsPedidos = LNClientesSmartTicketCinemex.ConsultaPedidos(
        ...
        protected void btnGuardarEstatus_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    LNClientesSmartTicketCinemex.ActualizaEstatusConfirmaClientes(Convert.ToInt32(cboEstatusConfirma.Value), Convert.ToInt32(this.hdID_Colectiva.Text), this.Usuario);
        ...
        protected void btnGenerarContrasena_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.hdeMail.Text != "")
                {
                    ...
                    LNClientesSmartTicketCinemex.GenerarContrasenaClientes(Convert.ToInt32(this.hdID_Colectiva.Text), this.hdeMail.Text, contrasena, this.Usuario);
        ...
        protected void btnAplicarBloqueo_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.hdeMail.Text != "")
                {
                    ...
                    LNClientesSmartTicketCinemex.AplicaBloqueoContracargoCliente(this.hdeMail.Text, rdBloqueado.Checked, txtComentario.Text, this.Usuario);
