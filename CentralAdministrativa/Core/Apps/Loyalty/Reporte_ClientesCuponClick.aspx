<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Reporte_ClientesCuponClick.aspx.cs" Inherits="CentroContacto.Reporte_ClientesCuponClick" %>
                                ...
                                <DirectEvents>
                                    <Click OnEvent="Download" IsUpload="true"
                                        After="Ext.net.Mask.show({ msg : 'Exportando Reporte a Excel...' });
                                            RepClientesCuponClick.StopMask();" />
                                </DirectEvents>
                            </ext:Button>
                        </Items>
                    </ext:Toolbar>
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="Cliente_Id">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="NumeroMembresia" />
                                    ...
                                    <ext:RecordField Name="fecha_nacimiento" />
                        ...
                        <Center Split="true">
                            <ext:GridPanel ID="GridPanelMovimientos" runat="server" StoreID="StoreMovimientos" StripeRows="true"
                                ...
                                <ColumnModel ID="ColumnModel1"  runat="server">
                                    <Columns>
                                        <ext:Column ColumnID="cliente_id" Header="Cliente" Sortable="true" DataIndex="cliente_id" Width="120" />
                                        <ext:Column ColumnID="Empresa" Header="Empresa" Sortable="true" DataIndex="Empresa" Width="120" />
                                        <ext:Column ColumnID="NumeroMembresia" Header="Membresia" Sortable="true" DataIndex="NumeroMembresia" Width="120" />
                                        <ext:DateColumn ColumnID="FechaExpiracion" Header="Fecha Expiracion" Sortable="true" DataIndex="FechaExpiracion" Format="yyyy-MM-dd" />
                                        ...
                                        <ext:DateColumn ColumnID="FechaInsert" Header="Fecha Insert" Sortable="true" DataIndex="FechaInsert" Format="yyyy-MM-dd HH:mm" />
                                        <ext:Column ColumnID="correo" Header="Correo" Sortable="true" DataIndex="correo" Width="180" />
                                        <ext:DateColumn ColumnID="fecha_nacimiento" Header="Fecha Nacimiento" Sortable="true" DataIndex="fecha_nacimiento" Format="yyyy-MM-dd" />
                                        <ext:Column ColumnID="Estado" Header="Estado" Sortable="true" DataIndex="Estado" Width="120" />
