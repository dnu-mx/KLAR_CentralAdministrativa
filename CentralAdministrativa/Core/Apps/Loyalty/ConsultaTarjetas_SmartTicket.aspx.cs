...
{
    public partial class ConsultaTarjetas_SmartTicket : DALCentralAplicaciones.PaginaBaseCAPP
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    StoreEstatus.DataSource = DAOConsultaTarjetasSmartTicket.ListaCatalogoEstatusTarjeta(this.Usuario);
        ...
        protected void LlenarGridResultados()
        {
            try
            {
                ...
                DataSet dsResultados = LNTarjetasSmartTicket.ConsultaClientes(elCliente, this.Usuario);
        ...
        protected void LlenaGridPanelTarjetas(int idcliente)
        {
            try
            {
                ...
                DataSet dsTarjetas = DAOConsultaTarjetasSmartTicket.ObtieneTarjetasCliente(idcliente, this.Usuario);
        ...
        public void ActualizaEstatusTarjeta(int IdTarjeta, string Valor)
        {
            try
            {
                LNTarjetasSmartTicket.ModificaEstatusTarjeta(IdTarjeta, int.Parse(Valor), this.Usuario);
