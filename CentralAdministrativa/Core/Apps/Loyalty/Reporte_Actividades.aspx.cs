...
{
    public partial class Reporte_Actividades : PaginaBaseCAPP
    {
        ...
        private void BuscaDatosAndBind()
        {
            try
            {
                ...
                GridPanel1.GetStore().DataSource = LNReportes.ReporteActividades(fechaInicio, fechaFin, tipoColectiva,  this.Usuario, Guid.Parse(ConfigurationManager.AppSettings["IDApplication"].ToString()));
