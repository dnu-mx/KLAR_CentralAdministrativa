<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PermisosAplicaciones.aspx.cs" Inherits="Usuarios.PermisosAplicaciones" %>
    ...
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        ...
        <East Split="true">
            <ext:Panel ID="FormPanel1" Width="600px" Collapsible="true" Collapsed="true" Title="Editando Usuarios"
                ...
                <Content>
                    <ext:Panel ID="Panel1" runat="server" Title="Asignación de Roles" Width="440" FormGroup="true">
                        <Content>
                            <ext:BorderLayout runat="server">
                                <North Split="true" MinHeight="90px" MaxHeight="90px">
                                    <ext:Panel Height="90px" runat="server" Border="false">
                                        <Content>
                                            <table>
                                                <tr>
                                                    <td colspan="2">
                                    ...
                                    <ext:GridPanel ID="GridPanel2" runat="server" Header="true" Title="Roles Asignados"
                                        ...
                                        <BottomBar>
                                            <ext:PagingToolbar ID="PagingToolBar2" runat="server" StoreID="SAppPerfil" DisplayInfo="true"
                                                DisplayMsg="Mostrando Roles Asignados {0} - {1} de {2}" HideRefresh="true" />
                                        </BottomBar>
                                    </ext:GridPanel>
                                </Center>
                            </ext:BorderLayout>
