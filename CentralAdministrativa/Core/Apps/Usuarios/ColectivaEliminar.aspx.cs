...
namespace Usuarios
{
    public partial class ColectivaEliminar : DALCentralAplicaciones.PaginaBaseCAPP
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                DAOColectiva.Eliminar(AsignarNuevosDatos(new Colectiva()), this.Usuario, Guid.Parse(ConfigurationManager.AppSettings["IDApplication"].ToString()));
            }
            catch (Exception )
            {
            }
        ...
        protected void DespliegaDatosColectiva(Int64 ID_Colectiva)
        {
            ...
            FormPanel1.Title = "Eliminar la Entidad Número [" + laColectivaEditar.ID_Colectiva + "]";
            TabPanel1.SetActiveTab(Panel1);

            HttpContext.Current.Session.Add("Colectiva", laColectivaEditar);

            txtemail.Text = laColectivaEditar.Email;
        ...
        protected Colectiva AsignarNuevosDatos(Colectiva laColectiva)
        {
            ...
            laColectiva.Email = txtemail.Text;
            laColectiva.ClaveColectiva = cmbTipoUsuario.Value.ToString();
