<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EditOperadores.aspx.cs" Inherits="OperadoraWeb.EditOperadores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        <Center Split="true">
            <ext:Panel ID="Panel2" runat="server" Title="Operadores" Collapsed="false" Layout="Fit"
            ...
            <ext:FormPanel ID="FormPanel1" Width="428.5" Title="Mi Grupo Comercial" runat="server"
                ...
                <Items>
                    <ext:TabPanel runat="server" ActiveTabIndex="0" TabPosition="Bottom" Border="false"
                        ...
                        <Items>
                            <ext:Panel ID="Panel1" runat="server" Title="Operadores" AutoHeight="true" FormGroup="true">
                                <Content>
