...
{
    public partial class AddAfiliaciones : PaginaBaseCAPP
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    try
                    {
                        cmbTipoUsuario.SetValueAndFireSelect(DALCentralAplicaciones.Utilidades.Configuracion.Get(Guid.Parse(ConfigurationManager.AppSettings["IDApplication"].ToString()), "ClaveTipoColectivaAfiliacion").Valor);
                        cmbTipoUsuario.SetValue(DALCentralAplicaciones.Utilidades.Configuracion.Get(Guid.Parse(ConfigurationManager.AppSettings["IDApplication"].ToString()), "ClaveTipoColectivaAfiliacion").Valor);
        ...
        protected void PreparaGridColectiva()
        {
            ...
            colClaveColectiva.Header = "Número";
