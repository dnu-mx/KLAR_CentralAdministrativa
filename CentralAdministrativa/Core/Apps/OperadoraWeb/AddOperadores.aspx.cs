    ...
    public partial class AddOperadores : PaginaBaseCAPP
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (LNColectiva.AgregarOperadorAOperadora(laColectiva, this.Usuario, Guid.Parse(ConfigurationManager.AppSettings["IDApplication"].ToString())) == 0)
                {
                    FormPanel1.Reset();
        ...
        protected Colectiva ObtieneNuevaColectiva()
        {
            ...
            laColectiva.ClaveColectiva = txtUserName.Text + lblArroba.Text + cmbCadenaComercial.SelectedItem.Text.Replace(" ","") + ".mx";
