<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditAfiliaciones.aspx.cs" Inherits="OperadoraWeb.EditAfiliaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   <ext:BorderLayout ID="BorderLayout1" runat="server">
        <Center Split="true">
            <ext:Panel ID="Panel2" runat="server" Title="Afiliaciones" Collapsed="false"
            ...
            <ext:FormPanel ID="FormPanel1" Width="428.5" Title="Mi Grupo Comercial" runat="server"
                ...
                <Items>
                    <ext:TabPanel runat="server" ActiveTabIndex="0" TabPosition="Bottom" Border="false"
                        ...
                        <Items>
                            <ext:Panel ID="Panel1" runat="server" Title="Afiliación" AutoHeight="true" FormGroup="true">
                                <Content>
