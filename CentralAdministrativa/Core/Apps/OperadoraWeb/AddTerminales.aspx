<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddTerminales.aspx.cs" Inherits="OperadoraWeb.AddTerminales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ext:BorderLayout ID="BorderLayout1" runat="server">
        <West Split="true">
            <ext:FormPanel ID="FormPanel1" Width="350" Title="Agregar Terminales" runat="server"
                ...
                <Items>
                    <ext:TabPanel runat="server" ActiveTabIndex="0" TabPosition="Bottom" Border="false"
                        ...
                        <Items>
                            <ext:Panel ID="Panel1" runat="server" Title="Nueva Terminal" AutoHeight="true" FormGroup="true">
                                <Content>
                                ...
                                <ext:ComboBox ID="cmbTipoUsuario" FieldLabel="Tipo Entidad" AllowBlank="false"
                                    ...
                                    <ext:ComboBox ID="cmbPadreTipoColectiva" FieldLabel="Afiliación" AllowBlank="false"
                                        MsgTarget="Side" runat="server" EmptyText="Selecciona una Afiliación" Width="320"
                                    ...
                                    <ext:TextField ID="txtUserName" FieldLabel="Clave" AllowBlank="false" MsgTarget="Side"
                                        MaxLength="16" runat="server" Text="" Width="320" />
                                    ...
                                    <ext:TextField ID="txtApaterno" FieldLabel="Ubicación 1" Visible="true" AllowBlank="false"
                                        MsgTarget="Side" MaxLength="50" runat="server" Text="" Width="320" />
                                    <ext:TextField ID="txtAmaterno" FieldLabel="Ubicación 2"  Visible="true" AllowBlank="false"
                                        MsgTarget="Side" MaxLength="50" runat="server" Width="320" Text="" />
                                    <ext:DateField FieldLabel="Fecha" AllowBlank="false" MsgTarget="Side"
                                        Format="yyyy-MM-dd" Name="Fecha Inicio" TabIndex="4" ID="datFecha" Width="320" runat="server"
                                        EmptyText="Selecciona una Opción" MaxLength="12" Vtype="daterange"   Visible="false"/>
        ...
        <Center Split="true">
            <ext:Panel ID="Panel5" runat="server" Title="Las Terminales" Collapsed="false"
                            ...
                            <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store2" StripeRows="true"
                                ...
                                <BottomBar>
                                    <ext:PagingToolbar ID="PagingToolBar1" runat="server" StoreID="Store2" DisplayInfo="true"
                                        DisplayMsg="Mostrando Terminales {0} - {1} de {2}" />
                                </BottomBar>
                                  <View>
