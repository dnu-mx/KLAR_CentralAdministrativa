...
namespace DALAdministracion.BaseDatos
{
    ...
    /// </summary>
    public class DAOCuentasBancarias_V2
    {
        /// <summary>
        ...
        /// <param name="AppID">Identificador de la aplicación</param>
        /// <returns>DataSet con los registros</returns>
        public static DataSet ObtieneDatosPersonalesCuenta(int idTarj, int idCol, IUsuario elUsuario, Guid AppID)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorMC.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneDatosPersonalesCuenta");
        ...
        public static void ActualizaDatosPersonalesCuenta(DatosPersonalesCuenta datosCuenta, IUsuario elUsuario)
        {
            try
            {
                ...
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaInfoCuentahabiente");
                ...
                Loguear.Evento("Se Actualizaron los Datos Personales de la Cuenta en el Autorizador", elUsuario.ClaveUsuario);
            }
            catch (Exception ex)
            {
                Loguear.Error(ex, elUsuario.ClaveUsuario);
        ...
        public static DataSet ObtieneDatosCuenta(int idCta, int idTarj, IUsuario elUsuario, Guid AppID)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorMC.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneDatosCuenta");
            ...
            String Valor, IUsuario elUser)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorMC.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaParametroProductoCuenta");
        ...
        /// <summary>
        /// Actualiza el valor de un parámetro del medio de acceso indicado en base de datos
        /// </summary>
        /// <param name="IdProducto">Identificador del producto (medio de acceso) por actualizar</param>
        /// <param name="Param">Parámetro por actualizar</param>
        /// <param name="Valor">Nuevo valor del parámetro por actualizar</param>
        /// <param name="elUser">Usuario en sesión</param>
        public static void ActualizaParametrosMedioAcceso(Int64 IdProducto, String Param, String Valor, IUsuario elUser)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorMC.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaMedioAcceso");
        ...
        /// <summary>
        /// Controla en base de datos el cambio en el límite de crédito del cliente
        /// </summary>
        /// <param name="IdCuenta">Identificador de la cuenta</param>
        /// <param name="IdProducto">Identificador del producto</param>
        /// <param name="LDCNuevo">Nuevo límite de crédito</param>
        /// <param name="PaginaAspx">Nombre de ka página ASPX que solicita el cambio</param>
        /// <param name="elUsuario">Usuario en sesión</param>
        /// <param name="AppID">Identificador de la aplicación</param>
        public static void ControlaCambioLimiteCredito(Int64 IdCuenta, Int64 IdProducto, string LDCNuevo,
            string PaginaAspx, IUsuario elUsuario, Guid AppID)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorMC.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_InsertaCambioLDC");

                database.AddInParameter(command, "@IdCuenta", DbType.Int64, IdCuenta);
                database.AddInParameter(command, "@IdProducto", DbType.Int64, IdProducto);
                database.AddInParameter(command, "@NuevoLDC", DbType.String, LDCNuevo);
                database.AddInParameter(command, "@PaginaAspx", DbType.String, PaginaAspx);
            ...
            {
                Loguear.Error(Ex, elUsuario.ClaveUsuario);
                throw new Exception("Ha sucedido un error al insertar el cambio de límite de crédito: " + Ex);
            }
        }
        ...
        /// <param name="elUsuario">Usuario en sesión</param>
        public static void RegistraCambioLimiteCredito(Int64 IdCuenta, string nuevoLDC, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorMC.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_AutorizaCambioLDC");

                database.AddInParameter(command, "@IdCuenta", DbType.Int64, IdCuenta);
                database.AddInParameter(command, "@NuevoLDC", DbType.String, nuevoLDC);
            ...
            {
                Loguear.Error(Ex, elUsuario.ClaveUsuario);
                throw new Exception("Ha sucedido un error al registrar el cambio en el límite de crédito: " + Ex);
            }
        }
    }
}
