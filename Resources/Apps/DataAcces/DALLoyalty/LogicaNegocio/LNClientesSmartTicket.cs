...
namespace DALCentroContacto.LogicaNegocio
{
    ...
    /// </summary>
    public class LNClientesSmartTicket
    {
        ...
        public static DataSet ConsultaClientes(ClienteColectiva cliente, Usuario usuario)
        {
            ...
            try
            {
                return DAOConsultaClientesSmartTicket.ObtieneClientes(cliente, usuario);
            }
        ...
        public static DataSet ConsultaPedidos(ClienteColectiva unCliente, DateTime fechaInicial, DateTime fechaFinal, Usuario usuario)
        {
            ...
            try
            {
                return DAOConsultaClientesSmartTicket.ObtienePedidos(unCliente, fechaInicial, fechaFinal, usuario);
            }
            ...
            Usuario usuario, Guid AppID)
        {
            ...
            try
            {
                return DAOConsultaClientesSmartTicket.ObtieneMovimientos(fechaInicial, fechaFinal,
        ...
        public static void ActualizaEstatusConfirmaClientes(int IdEstatus, int IdColectiva, Usuario usuario)
        {
            try
            {
                using (SqlConnection conn = BDAutorizadorRedVoucher.BDEscritura)
                {
                    conn.Open();
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaClientesSmartTicket.ActualizaEstatusConfirma(IdColectiva, IdEstatus, usuario);
            ...
            try
            {
                using (SqlConnection conn = BDAutorizadorRedVoucher.BDEscritura)
                {
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaClientesSmartTicket.ActualizaContrasenaCliente(Correo, Contrasena, usuario);
                            DAOConsultaClientesSmartTicket.ActualizaEstatusConfirma(IdColectiva, 1, usuario);
        ...
        public static void AplicaBloqueoContracargoCliente(string Correo, bool Estatus, string Comentarios, Usuario usuario)
        {
            try
            {
                using (SqlConnection conn = BDEAdminEcommerce.BDEscritura)
                {
                    conn.Open();
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaClientesSmartTicket.ActualizaEstatusBloqueoCliente(Correo, Estatus, Comentarios, usuario);
