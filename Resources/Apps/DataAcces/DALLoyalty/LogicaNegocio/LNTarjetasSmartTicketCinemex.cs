...
namespace CentroContacto.LogicaNegocio
{
    ...
    /// </summary>
    public class LNTarjetasSmartTicketCinemex
    {
        /// <summary>
        ...
        public static DataSet ConsultaClientes(Cliente cliente, IUsuario usuario)
        {
            ...
            try
            {
                return DAOConsultaTarjetasSmartTicketCinemex.ObtieneClientes(cliente, usuario);
            }
        ...
        public static void ModificaEstatusTarjeta(int IdTarjeta, int IdEstatus, IUsuario usuario)
        {
            try
            {
                using (SqlConnection conn = BDEcommerceCinemex.BDEscritura)
                {
                    conn.Open();
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaTarjetasSmartTicketCinemex.ActualizaEstatusTarjetaCliente(IdTarjeta,
