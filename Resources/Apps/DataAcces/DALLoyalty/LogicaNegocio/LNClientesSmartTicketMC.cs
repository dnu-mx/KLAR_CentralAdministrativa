...
namespace DALCentroContacto.LogicaNegocio
{
    ...
    /// </summary>
    public class LNClientesSmartTicketMC
    {
        ...
        public static DataSet ConsultaClientes(ClienteColectiva cliente, Usuario usuario)
        {
            ...
            try
            {
                return DAOConsultaClientesSmartTicketMC.ObtieneClientes(cliente, usuario);
            }
        ...
        public static DataSet ConsultaPedidos(ClienteColectiva unCliente, DateTime fechaInicial, DateTime fechaFinal, Usuario usuario)
        {
            ...
            try
            {
                return DAOConsultaClientesSmartTicketMC.ObtienePedidos(unCliente, fechaInicial, fechaFinal, usuario);
            }
            ...
            Usuario usuario, Guid AppID)
        {
            ...
            try
            {
                return DAOConsultaClientesSmartTicketMC.ObtieneMovimientos(fechaInicial, fechaFinal,
        ...
        public static void ActualizaEstatusConfirmaClientes(int IdEstatus, int IdColectiva, Usuario usuario)
        {
            try
            {
                using (SqlConnection conn = BDAutorizadorRedVoucherMC.BDEscritura)
                {
                    conn.Open();
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaClientesSmartTicketMC.ActualizaEstatusConfirma(IdColectiva, IdEstatus, usuario);
            ...
            try
            {
                using (SqlConnection conn = BDAutorizadorRedVoucherMC.BDEscritura)
                {
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaClientesSmartTicketMC.ActualizaContrasenaCliente(Correo, Contrasena, usuario);
                            DAOConsultaClientesSmartTicketMC.ActualizaEstatusConfirma(IdColectiva, 1, usuario);
        ...
        public static void AplicaBloqueoContracargoCliente(string Correo, bool Estatus, string Comentarios, Usuario usuario)
        {
            try
            {
                using (SqlConnection conn = BDEAdminEcommerceMC.BDEscritura)
                {
                    conn.Open();
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaClientesSmartTicketMC.ActualizaEstatusBloqueoCliente(Correo, Estatus, Comentarios, usuario);
