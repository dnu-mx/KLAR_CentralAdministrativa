...
{
    /// <summary>
    /// Establece la lógica del negocio del acceso a datos de Clientes SmartTicket
    /// </summary>
    public class LNClientesSmartTicketCinemex
    {
        ...
        public static DataSet ConsultaClientes(ClienteColectiva cliente, Usuario usuario)
        {
            ...
            try
            {
                return DAOConsultaClientesSmartTicketCinemex.ObtieneClientes(cliente, usuario);
            }
        ...
        public static DataSet ConsultaPedidos(ClienteColectiva unCliente, DateTime fechaInicial, DateTime fechaFinal, Usuario usuario)
        {
            ...
            try
            {
                return DAOConsultaClientesSmartTicketCinemex.ObtienePedidos(unCliente, fechaInicial, fechaFinal, usuario);
            }
            ...
            Usuario usuario, Guid AppID)
        {
            ...
            try
            {
                return DAOConsultaClientesSmartTicketCinemex.ObtieneMovimientos(fechaInicial, fechaFinal,
        ...
        public static void ActualizaEstatusConfirmaClientes(int IdEstatus, int IdColectiva, Usuario usuario)
        {
            try
            {
                using (SqlConnection conn = BDAutorizadorRedVoucherCinemex.BDEscritura)
                {
                    conn.Open();
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaClientesSmartTicketCinemex.ActualizaEstatusConfirma(IdColectiva, IdEstatus, usuario);
            ...
            try
            {
                using (SqlConnection conn = BDAutorizadorRedVoucherCinemex.BDEscritura)
                {
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaClientesSmartTicketCinemex.ActualizaContrasenaCliente(Correo, Contrasena, usuario);
                            DAOConsultaClientesSmartTicketCinemex.ActualizaEstatusConfirma(IdColectiva, 1, usuario);
        ...
        public static void AplicaBloqueoContracargoCliente(string Correo, bool Estatus, string Comentarios, Usuario usuario)
        {
            try
            {
                using (SqlConnection conn = BDEAdminEcommerceCinemex.BDEscritura)
                {
                    conn.Open();
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaClientesSmartTicketCinemex.ActualizaEstatusBloqueoCliente(Correo, Estatus, Comentarios, usuario);
