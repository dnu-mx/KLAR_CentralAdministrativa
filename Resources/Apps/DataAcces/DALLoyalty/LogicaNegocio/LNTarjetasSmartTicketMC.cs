...
namespace CentroContacto.LogicaNegocio
{
    ...
    /// </summary>
    public class LNTarjetasSmartTicketMC
    {
        /// <summary>
        ...
        public static DataSet ConsultaClientes(Cliente cliente, IUsuario usuario)
        {
            ...
            try
            {
                return DAOConsultaTarjetasSmartTicketMC.ObtieneClientes(cliente, usuario);
            }
        ...
        public static void ModificaEstatusTarjeta(int IdTarjeta, int IdEstatus, IUsuario usuario)
        {
            try
            {
                using (SqlConnection conn = BDEcommerceMC.BDEscritura)
                {
                    conn.Open();
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            DAOConsultaTarjetasSmartTicketMC.ActualizaEstatusTarjetaCliente(IdTarjeta,
