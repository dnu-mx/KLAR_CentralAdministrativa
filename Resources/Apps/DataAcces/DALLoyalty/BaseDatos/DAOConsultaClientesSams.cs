...
namespace DALCentroContacto.BaseDatos
{
    ...
    /// </summary>
    public class DAOConsultaClientesSams
    {
        /// <summary>
        ...
        public static DataSet ObtieneClientes(ClienteColectiva elCliente, IUsuario elUsuario)
        {
            try
            {
                ...
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneClientesSams");
        ...
        public static DataSet ObtieneDatosCliente(int idCliente, int idColectiva, IUsuario elUsuario)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDEcommercePrana.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneDatosClienteSams");
        ...
        public static DataSet ObtieneBloqueoCliente(string Correo, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAdminPromociones.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneEstatusBloqueoClienteSams");
        ...
        public static void ActualizaEstatusBloqueoCliente(string Correo, bool Estatus, string Comentarios, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAdminPromociones.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaEstatusBloqueoClienteSams");
        ...
        public static void ActualizaEstatusConfirma(int IdColectiva, int idEstatus, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorPromociones.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaEstatusClienteSams");
        ...
        public static void ActualizaContrasenaCliente(string Correo, string Contrasena, IUsuario elUsuario)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDAdminPromociones.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaContrasenaClienteSams");
        ...
        public static void ActualizaMembresiaCliente(string Correo, string Membresia, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDEcommercePrana.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaMembresiaClienteSams");
