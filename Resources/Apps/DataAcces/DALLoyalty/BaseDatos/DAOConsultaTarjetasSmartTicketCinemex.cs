...
namespace DALCentroContacto.BaseDatos
{
    ...
    /// </summary>
    public class DAOConsultaTarjetasSmartTicketCinemex
    {
        /// <summary>
        ...
        public static DataSet ListaCatalogoEstatusTarjeta(IUsuario elUsuario)
        {
            try
            {
                ...
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneEstatusTarjetaCinemex");
        ...
        public static DataSet ObtieneClientes(Cliente elCliente, IUsuario elUsuario)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDEcommerceCinemex.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneClientesTarjetasCinemex");
        ...
        public static DataSet ObtieneTarjetasCliente(int idCliente, IUsuario elUsuario)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDEcommerceCinemex.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneTarjetasClienteCinemex");
            ...
            SqlTransaction transaccionSQL, IUsuario elUsuario)
        {
            try
            {
                SqlCommand command = new SqlCommand("web_CA_ActualizaEstatusTarjetaClienteCinemex", connection);
