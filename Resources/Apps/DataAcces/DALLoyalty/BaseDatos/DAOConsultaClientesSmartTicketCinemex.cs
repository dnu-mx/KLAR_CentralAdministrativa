...
namespace DALCentroContacto.BaseDatos
{
    ...
    /// </summary>
    public class DAOConsultaClientesSmartTicketCinemex
    {
        /// <summary>
        ...
        public static DataSet ObtieneClientes(ClienteColectiva elCliente, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDEcommerceCinemex.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneClientesCinemex");
        ...
        public static DataSet ObtieneDatosCliente(int idCliente, int idColectiva, IUsuario elUsuario)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDEcommerceCinemex.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneDatosClienteSTCinemex");
        ...
        public static DataSet ObtieneBloqueoCliente(string Correo, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDEAdminEcommerceCinemex.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneEstatusBloqueoClienteSTCinemex");
        ...
        public static void ActualizaEstatusBloqueoCliente(string Correo, bool Estatus, string Comentarios, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDEAdminEcommerceCinemex.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaEstatusBloqueoClienteSTCinemex");
        ...
        public static DataSet ObtienePedidos(ClienteColectiva elCliente, DateTime fIni, DateTime fFin, IUsuario elUsuario)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDEcommerceCinemex.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtienePedidosClienteCinemex");
        ...
        public static DataSet ObtieneMovimientos(DateTime fIni, DateTime fFin, int idCol, IUsuario elUsuario, Guid AppID)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorRedVoucherCinemex.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneMovimientosCinemex");
        ...
        public static void ActualizaEstatusConfirma(int IdColectiva, int idEstatus, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorRedVoucherCinemex.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaEstatusClienteSTCinemex");
        ...
        public static void ActualizaContrasenaCliente(string Correo, string Contrasena, IUsuario elUsuario)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDEAdminEcommerceCinemex.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaContrasenaClienteSTCinemex");
