...
namespace DALCentroContacto.BaseDatos
{
    ...
    /// </summary>
    public class DAOConsultaClientesCCIMEF
    {
        /// <summary>
        ...
        public static DataSet ObtieneClientes(ClienteColectiva elCliente, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDEcommerceCCIMEF.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneClientesCCIMEF");
        ...
        public static DataSet ObtieneDatosCliente(int idCliente, int idColectiva, IUsuario elUsuario)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDEcommerceCCIMEF.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneDatosClienteCCIMEF");
        ...
        public static DataSet ObtieneBloqueoCliente(string Correo, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAdminCCIMEF.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneEstatusBloqueoClienteCCIMEF");
        ...
        public static void ActualizaEstatusBloqueoCliente(string Correo, bool Estatus, string Comentarios, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAdminCCIMEF.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaEstatusBloqueoClienteCCIMEF");
        ...
        public static void ActualizaEstatusConfirma(int IdColectiva, int idEstatus, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizadorCCIMEF.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaEstatusClienteCCIMEF");
        ...
        public static void ActualizaContrasenaCliente(string Correo, string Contrasena, IUsuario elUsuario)
        {
            ...
            {
                SqlDatabase database = new SqlDatabase(BDAdminCCIMEF.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaContrasenaClienteCCIMEF");
        ...
        public static void ActualizaMembresiaCliente(string Correo, string Membresia, IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDEcommerceCCIMEF.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaMembresiaClienteCCIMEF");
