...
{
    /// <summary>
    /// Establece la lógica del negocio del nivel de acceso a datos de CashAE
    /// </summary>
    public class LNCash
    {
        /// <summary>
                ...
                using (SqlConnection conn = BDAutorizadorCash.BDEscritura)
                {
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        try
                        {
                            ...
                            {
                                DAOCash.ActualizaValorReglaPorGpoCuenta(unValor, Id_cadena, ID_Regla, IdGpoCuenta,
                                    elUser, conn, transaccionSQL);
                            }
