...
namespace DALLealtad.BaseDatos
{
    ...
    {
        /// <summary>
        /// Consulta los parámetros necesarios para obtener los valores de la regla en base de datos
        /// </summary>
        /// <param name="ClaveRegla">Clave de la regla</param>
        /// <param name="elUsuario">Usuario en sesión</param>
        /// <param name="AppID">Identificador de la aplicación</param>
        /// <returns>DataSet con los registros</returns>
        public static DataSet ObtieneParamsRegla(String ClaveRegla, IUsuario elUsuario, Guid AppID)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizador.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneParamsRegla");

                database.AddInParameter(command, "@ClaveRegla", DbType.String, ClaveRegla);
        ...
        /// <summary>
        /// Consulta en base de datos la lista de valores que corresponden a la regla,
        /// cadena y grupo de cuentas indicados, discriminando ciertos valores
        /// </summary>
        /// <param name="ID_Regla">Identificador de la regla</param>
        /// <param name="ID_CadenaComercial">Identificador de la cadena comercial</param>
        /// <param name="ID_GrupoCuenta">Identificador del grupo de cuentas</param>
        ...
        /// <param name="AppID">Identificador de la aplicación</param>
        /// <returns>Diccionario con los valores de la regla</returns>
        public static Dictionary<String, ValorRegla> ListaValoresReglaPorGpoCta_SinValores(Int64 ID_Regla, Int64 ID_CadenaComercial,
            int ID_GrupoCuenta, IUsuario elUsuario, Guid AppID)
        {
            try
            {
                ...
                SqlDatabase database = new SqlDatabase(BDAutorizador.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneValoresReglaPorGpoCuentaConFiltro");
        ...
        public static void ActualizaValorReglaPorGpoCuenta(ValorRegla elValor, Int64 Id_cadena, Int64 ID_Regla, 
            int ID_GrupoCuenta, IUsuario elUser)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizador.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaValorReglaPorGpoCuenta");

                database.AddInParameter(command, "@ID_Cadena", DbType.Int64, Id_cadena);
                database.AddInParameter(command, "@ID_Regla", DbType.Int64, ID_Regla);
                database.AddInParameter(command, "@ID_GrupoCuenta", DbType.Int32, ID_GrupoCuenta);
                database.AddInParameter(command, "@ValorNuevo", DbType.String, elValor.Valor);
                database.AddInParameter(command, "@Nombre", DbType.String, elValor.Nombre);
            ...
            long idCadena, IUsuario elUsuario)
        {
            try
            {
                ...
                //using (SqlCommand cmd = new SqlCommand("web_CA_ClonarEventoYAsignarAPertencias", conn))
        ...
        /// <summary>
        /// Consulta el catálogo de empresas del Autorizador
        /// </summary>
        /// <param name="elUsuario">Usuario en sesión</param>
        /// <returns>DataSet con los datos del catálogo</returns>
        public static DataSet ObtieneCatalogoEmpresas(IUsuario elUsuario)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizador.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneEmpresas");
        ...
        /// <summary>
        /// Consulta los parámetros necesarios para obtener los valores del convenio con 
        /// la empresa en base de datos
        /// </summary>
        /// <param name="TipoOper">Tipo de operación</param>
        /// <param name="elUsuario">Usuario en sesión</param>
        /// <param name="AppID">Identificador de la aplicación</param>
        /// <returns>DataSet con los registros</returns>
        public static DataSet ObtieneParamsConvEmpresa(Int32 TipoOper, IUsuario elUsuario, Guid AppID)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizador.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneParamsConvenioEmpresa");

                database.AddInParameter(command, "@IdTipoOperacion", DbType.Int32, TipoOper);
                database.AddInParameter(command, "@UserTemp", DbType.Guid, elUsuario.UsuarioTemp);
                database.AddInParameter(command, "@AppId", DbType.Guid, AppID);
        ...
        /// <summary>
        /// Consulta en base de datos la lista de valores de la regla convenio con empresa
        /// que corresponden al grupo de medios de acceso (empresa)
        /// </summary>
        /// <param name="TipoOper">Tipo de operación</param>
        /// <param name="IdRegla">Identificador de la regla</param>
        /// <param name="IdCadena">Identificador de la cadena comercial</param>
        /// <param name="ID_GrupoMA">Identificador del grupo de medios de acceso</param>
        /// <param name="elUsuario">Usuario en sesión</param>
        /// <param name="AppID">Identificador de la aplicación</param>
        /// <returns>Diccionario con los valores de la regla</returns>
        public static Dictionary<String, ValorRegla> ListaValoresReglaConvEmpresa(int TipoOper, int IdRegla, 
            int IdCadena, int ID_GrupoMA, IUsuario elUsuario, Guid AppID)
        {
            try
            {
                Dictionary<String, ValorRegla> larespuesta = new Dictionary<String, ValorRegla>();
                ...
                SqlDatabase database = new SqlDatabase(BDAutorizador.strBDLectura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ObtieneValoresReglaConvEmpresa");
                ...
                database.AddInParameter(command, "@ID_GpoMediosAcceso", DbType.Int32, ID_GrupoMA);
        ...
        /// <summary>
        /// Actualiza en base de datos los valores de la regla, cadena y 
        /// grupo de medios de acceso indicados
        /// </summary>
        /// <param name="elValor">Valor del parámetro</param>
        /// <param name="Id_cadena">Identificador de la cadena comercial</param>
        /// <param name="ID_Regla">Identificador de la regla</param>
        /// <param name="ID_GrupoMA">Identificador del grupo de medios de acceso</param>
        /// <param name="elUser">Usuario en sesión</param>
        public static void ActualizaValorReglaPorGrupoMA(ValorRegla elValor, Int64 Id_cadena, Int64 ID_Regla,
            int ID_GrupoMA, IUsuario elUser)
        {
            try
            {
                SqlDatabase database = new SqlDatabase(BDAutorizador.strBDEscritura);
                DbCommand command = database.GetStoredProcCommand("web_CA_ActualizaValorReglaPorGrupoMA");

                database.AddInParameter(command, "@ID_Cadena", DbType.Int64, Id_cadena);
                database.AddInParameter(command, "@ID_Regla", DbType.Int64, ID_Regla);
                database.AddInParameter(command, "@ID_GrupoMA", DbType.Int32, ID_GrupoMA);
                database.AddInParameter(command, "@ValorNuevo", DbType.String, elValor.Valor);
                database.AddInParameter(command, "@Nombre", DbType.String, elValor.Nombre);
            ...
            {
                throw new Exception("ActualizaValorReglaPorGpoMA()", Ex);
            }
        }
    }
}
